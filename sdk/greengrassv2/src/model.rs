...
pub struct ResolvedComponentVersion  {
    ...
    /// </ul>
    #[doc(hidden)]pub vendor_guidance: std::option::Option<crate::model::VendorGuidance>,
...
pub struct ComponentCandidate  {
    ...
    #[doc(hidden)]pub version_requirements: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct InstalledComponent  {
    ...
    #[doc(hidden)]pub lifecycle_state: std::option::Option<crate::model::InstalledComponentLifecycleState>,
    ...
    #[doc(hidden)]pub lifecycle_state_details: std::option::Option<std::string::String>,
    /// <p>Whether or not the component is a root component.</p>
    #[doc(hidden)]pub is_root: bool,
    ...
    #[doc(hidden)]pub last_status_change_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub last_reported_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub last_installation_source: std::option::Option<std::string::String>,
    ...
    /// </note>
    #[doc(hidden)]pub lifecycle_status_codes: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
impl  std::fmt::Debug for InstalledComponent  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("last_status_change_timestamp", &self.last_status_change_timestamp);
        formatter.field("last_reported_timestamp", &self.last_reported_timestamp);
        formatter.field("last_installation_source", &self.last_installation_source);
        formatter.field("lifecycle_status_codes", &self.lifecycle_status_codes);
        formatter.finish()
    }
}
...
pub struct EffectiveDeployment  {
    ...
    #[doc(hidden)]pub core_device_execution_status: std::option::Option<crate::model::EffectiveDeploymentExecutionStatus>,
    ...
    #[doc(hidden)]pub status_details: std::option::Option<crate::model::EffectiveDeploymentStatusDetails>,
}
...
impl  std::fmt::Debug for EffectiveDeployment  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("core_device_execution_status", &self.core_device_execution_status);
...
pub struct EffectiveDeploymentStatusDetails  {
    ...
    #[doc(hidden)]pub error_stack: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub error_types: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
impl  std::fmt::Debug for EffectiveDeploymentStatusDetails  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("EffectiveDeploymentStatusDetails");
        formatter.field("error_stack", &self.error_stack);
        formatter.field("error_types", &self.error_types);
        formatter.finish()
    }
}
...
pub struct Component  {
    ...
    #[doc(hidden)]pub latest_version: std::option::Option<crate::model::ComponentLatestVersion>,
}
impl Component {
    /// <p>The <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">ARN</a> of the component version.</p>
    pub fn arn(&self) -> std::option::Option<& str> {
...
pub struct AssociatedClientDevice  {
    ...
    #[doc(hidden)]pub association_timestamp: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct DeploymentIoTJobConfiguration  {
    ...
    #[doc(hidden)]pub job_executions_rollout_config: std::option::Option<crate::model::IoTJobExecutionsRolloutConfig>,
    /// <p>The stop configuration for the job. This configuration defines when and how to stop a job rollout.</p>
    #[doc(hidden)]pub abort_config: std::option::Option<crate::model::IoTJobAbortConfig>,
    ...
    #[doc(hidden)]pub timeout_config: std::option::Option<crate::model::IoTJobTimeoutConfig>,
}
...
pub struct IoTJobTimeoutConfig  {
    ...
    #[doc(hidden)]pub in_progress_timeout_in_minutes: std::option::Option<i64>,
}
...
impl  std::fmt::Debug for IoTJobTimeoutConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("in_progress_timeout_in_minutes", &self.in_progress_timeout_in_minutes);
        formatter.finish()
    }
}
...
pub struct IoTJobAbortConfig  {
    ...
    #[doc(hidden)]pub criteria_list: std::option::Option<std::vec::Vec<crate::model::IoTJobAbortCriteria>>,
}
...
pub struct IoTJobAbortCriteria  {
    ...
    #[doc(hidden)]pub failure_type: std::option::Option<crate::model::IoTJobExecutionFailureType>,
    /// <p>The action to perform when the criteria are met.</p>
    #[doc(hidden)]pub action: std::option::Option<crate::model::IoTJobAbortAction>,
...
impl  std::fmt::Debug for IoTJobAbortCriteria  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("min_number_of_executed_things", &self.min_number_of_executed_things);
        formatter.finish()
    }
}
...
pub struct IoTJobExecutionsRolloutConfig  {
    ...
    #[doc(hidden)]pub exponential_rate: std::option::Option<crate::model::IoTJobExponentialRolloutRate>,
    /// <p>The maximum number of devices that receive a pending job notification, per minute.</p>
    #[doc(hidden)]pub maximum_per_minute: std::option::Option<i32>,
}
...
pub struct IoTJobExponentialRolloutRate  {
    ...
    #[doc(hidden)]pub base_rate_per_minute: i32,
    ...
    #[doc(hidden)]pub increment_factor: f64,
    /// <p>The criteria to increase the rollout rate for the job.</p>
    #[doc(hidden)]pub rate_increase_criteria: std::option::Option<crate::model::IoTJobRateIncreaseCriteria>,
}
...
pub struct IoTJobRateIncreaseCriteria  {
    ...
    #[doc(hidden)]pub number_of_notified_things: std::option::Option<i32>,
    /// <p>The number of devices to successfully run the configuration job before the rollout rate increases.</p>
    #[doc(hidden)]pub number_of_succeeded_things: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for IoTJobRateIncreaseCriteria  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("number_of_succeeded_things", &self.number_of_succeeded_things);
        formatter.finish()
    }
}
...
pub struct DeploymentPolicies  {
    ...
    #[doc(hidden)]pub failure_handling_policy: std::option::Option<crate::model::DeploymentFailureHandlingPolicy>,
    ...
    #[doc(hidden)]pub component_update_policy: std::option::Option<crate::model::DeploymentComponentUpdatePolicy>,
    ...
    #[doc(hidden)]pub configuration_validation_policy: std::option::Option<crate::model::DeploymentConfigurationValidationPolicy>,
}
...
impl  std::fmt::Debug for DeploymentPolicies  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("configuration_validation_policy", &self.configuration_validation_policy);
        formatter.finish()
    }
}
...
pub struct DeploymentComponentUpdatePolicy  {
    ...
    #[doc(hidden)]pub action: std::option::Option<crate::model::DeploymentComponentUpdatePolicyAction>,
}
...
pub struct ComponentDeploymentSpecification  {
    ...
    #[doc(hidden)]pub configuration_update: std::option::Option<crate::model::ComponentConfigurationUpdate>,
    ...
    #[doc(hidden)]pub run_with: std::option::Option<crate::model::ComponentRunWith>,
}
...
pub struct ComponentRunWith  {
    ...
    #[doc(hidden)]pub posix_user: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub system_resource_limits: std::option::Option<crate::model::SystemResourceLimits>,
    ...
    #[doc(hidden)]pub windows_user: std::option::Option<std::string::String>,
}
...
pub struct ComponentConfigurationUpdate  {
    ...
    #[doc(hidden)]pub merge: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub reset: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct CloudComponentStatus  {
    ...
    #[doc(hidden)]pub component_state: std::option::Option<crate::model::CloudComponentState>,
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>The vendor guidance state for the component version. This state indicates whether the component version has any issues that you should consider before you deploy it. The vendor guidance state can be:</p> 
    /// <ul> 
    /// <li> <p> <code>ACTIVE</code> – This component version is available and recommended for use.</p> </li> 
    /// <li> <p> <code>DISCONTINUED</code> – This component version has been discontinued by its publisher. You can deploy this component version, but we recommend that you use a different version of this component.</p> </li> 
    ...
    #[doc(hidden)]pub vendor_guidance: std::option::Option<crate::model::VendorGuidance>,
    /// <p>A message that communicates details about the vendor guidance state of the component version. This message communicates why a component version is discontinued or deleted.</p>
    #[doc(hidden)]pub vendor_guidance_message: std::option::Option<std::string::String>,
}
...
pub struct LambdaFunctionRecipeSource  {
    ...
    #[doc(hidden)]pub component_version: std::option::Option<std::string::String>,
    /// <p>The platforms that the component version supports.</p>
    #[doc(hidden)]pub component_platforms: std::option::Option<std::vec::Vec<crate::model::ComponentPlatform>>,
    /// <p>The component versions on which this Lambda function component depends.</p>
    #[doc(hidden)]pub component_dependencies: std::option::Option<std::collections::HashMap<std::string::String, crate::model::ComponentDependencyRequirement>>,
    /// <p>The system and runtime parameters for the Lambda function as it runs on the Greengrass core device.</p>
    #[doc(hidden)]pub component_lambda_parameters: std::option::Option<crate::model::LambdaExecutionParameters>,
}
...
impl  std::fmt::Debug for LambdaFunctionRecipeSource  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("component_lambda_parameters", &self.component_lambda_parameters);
        formatter.finish()
    }
}
...
pub struct LambdaExecutionParameters  {
    ...
    #[doc(hidden)]pub event_sources: std::option::Option<std::vec::Vec<crate::model::LambdaEventSource>>,
    ...
    #[doc(hidden)]pub max_queue_size: std::option::Option<i32>,
    /// <p>The maximum number of instances that a non-pinned Lambda function can run at the same time.</p>
    #[doc(hidden)]pub max_instances_count: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub max_idle_time_in_seconds: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub status_timeout_in_seconds: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub pinned: std::option::Option<bool>,
    /// <p>The encoding type that the Lambda function supports.</p> 
    /// <p>Default: <code>json</code> </p>
    #[doc(hidden)]pub input_payload_encoding_type: std::option::Option<crate::model::LambdaInputPayloadEncodingType>,
    /// <p>The list of arguments to pass to the Lambda function when it runs.</p>
    #[doc(hidden)]pub exec_args: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub linux_process_params: std::option::Option<crate::model::LambdaLinuxProcessParams>,
}
...
impl  std::fmt::Debug for LambdaExecutionParameters  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("input_payload_encoding_type", &self.input_payload_encoding_type);
...
pub struct LambdaLinuxProcessParams  {
    ...
    #[doc(hidden)]pub isolation_mode: std::option::Option<crate::model::LambdaIsolationMode>,
    /// <p>The parameters for the container in which the Lambda function runs.</p>
    #[doc(hidden)]pub container_params: std::option::Option<crate::model::LambdaContainerParams>,
}
...
pub struct LambdaContainerParams  {
    ...
    #[doc(hidden)]pub memory_size_in_kb: std::option::Option<i32>,
    /// <p>Whether or not the container can read information from the device's <code>/sys</code> folder.</p> 
    /// <p>Default: <code>false</code> </p>
    #[doc(hidden)]pub mount_ro_sysfs: std::option::Option<bool>,
    /// <p>The list of volumes that the container can access.</p>
    #[doc(hidden)]pub volumes: std::option::Option<std::vec::Vec<crate::model::LambdaVolumeMount>>,
    /// <p>The list of system devices that the container can access.</p>
    #[doc(hidden)]pub devices: std::option::Option<std::vec::Vec<crate::model::LambdaDeviceMount>>,
}
...
pub struct LambdaDeviceMount  {
    ...
    #[doc(hidden)]pub permission: std::option::Option<crate::model::LambdaFilesystemPermission>,
    /// <p>Whether or not to add the component's system user as an owner of the device.</p> 
    /// <p>Default: <code>false</code> </p>
    #[doc(hidden)]pub add_group_owner: std::option::Option<bool>,
}
...
pub struct LambdaEventSource  {
    ...
    /// </ul>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::LambdaEventSourceType>,
}
...
pub struct ComponentDependencyRequirement  {
    ...
    #[doc(hidden)]pub dependency_type: std::option::Option<crate::model::ComponentDependencyType>,
}
