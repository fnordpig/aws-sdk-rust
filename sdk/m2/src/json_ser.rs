...
pub fn serialize_union_crate_model_data_set_import_config(object_13: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataSetImportConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub fn serialize_union_crate_model_storage_configuration(object_32: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::StorageConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub fn serialize_union_crate_model_batch_job_identifier(object_41: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchJobIdentifier) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub fn serialize_union_crate_model_external_location(object_69: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ExternalLocation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub fn serialize_union_crate_model_dataset_org_attributes(object_80: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatasetOrgAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
