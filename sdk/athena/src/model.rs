...
pub struct ResultReuseConfiguration  {
    ...
    #[doc(hidden)]pub result_reuse_by_age_configuration: std::option::Option<crate::model::ResultReuseByAgeConfiguration>,
}
...
impl  std::fmt::Debug for ResultReuseConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ResultReuseConfiguration");
        formatter.field("result_reuse_by_age_configuration", &self.result_reuse_by_age_configuration);
        formatter.finish()
    }
}
...
pub struct ResultReuseByAgeConfiguration  {
    ...
    #[doc(hidden)]pub max_age_in_minutes: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for ResultReuseByAgeConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ResultReuseByAgeConfiguration");
        formatter.field("enabled", &self.enabled);
        formatter.field("max_age_in_minutes", &self.max_age_in_minutes);
        formatter.finish()
    }
}
...
pub struct QueryExecutionStatistics  {
    ...
    #[doc(hidden)]pub result_reuse_information: std::option::Option<crate::model::ResultReuseInformation>,
}
...
impl  std::fmt::Debug for QueryExecutionStatistics  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("query_planning_time_in_millis", &self.query_planning_time_in_millis);
        formatter.field("service_processing_time_in_millis", &self.service_processing_time_in_millis);
        formatter.field("result_reuse_information", &self.result_reuse_information);
        formatter.finish()
    }
}
...
pub struct ResultReuseInformation  {
    ...
    #[doc(hidden)]pub reused_previous_result: bool,
}
...
impl  std::fmt::Debug for ResultReuseInformation  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ResultReuseInformation");
        formatter.field("reused_previous_result", &self.reused_previous_result);
        formatter.finish()
    }
}
