...
pub fn serialize_structure_crate_input_start_query_execution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartQueryExecutionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_97) = &input.result_reuse_configuration {
        let mut object_98 = object.key("ResultReuseConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_result_reuse_configuration(&mut object_98, var_97)?;
        object_98.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_stop_query_execution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StopQueryExecutionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_99) = &input.query_execution_id {
        object.key("QueryExecutionId").string(var_99.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_data_catalog_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDataCatalogInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_112) = &input.parameters {
        let mut object_113 = object.key("Parameters").start_object();
...
pub fn serialize_structure_crate_input_update_named_query_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateNamedQueryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_116) = &input.named_query_id {
        object.key("NamedQueryId").string(var_116.as_str());
    }
...
pub fn serialize_structure_crate_input_update_prepared_statement_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePreparedStatementInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_120) = &input.statement_name {
        object.key("StatementName").string(var_120.as_str());
    }
    if let Some(var_121) = &input.work_group {
        object.key("WorkGroup").string(var_121.as_str());
    }
    if let Some(var_122) = &input.query_statement {
        object.key("QueryStatement").string(var_122.as_str());
    }
...
pub fn serialize_structure_crate_input_update_work_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateWorkGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_124) = &input.work_group {
        object.key("WorkGroup").string(var_124.as_str());
    }
    if let Some(var_125) = &input.description {
        object.key("Description").string(var_125.as_str());
    }
    if let Some(var_126) = &input.configuration_updates {
        let mut object_127 = object.key("ConfigurationUpdates").start_object();
        crate::json_ser::serialize_structure_crate_model_work_group_configuration_updates(&mut object_127, var_126)?;
        object_127.finish();
    }
...
pub fn serialize_structure_crate_model_work_group_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WorkGroupConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_131) = &input.result_configuration {
        let mut object_132 = object.key("ResultConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_result_configuration(&mut object_132, var_131)?;
        object_132.finish();
    }
    if let Some(var_133) = &input.enforce_work_group_configuration {
        object.key("EnforceWorkGroupConfiguration").boolean(*var_133);
    }
    if let Some(var_134) = &input.publish_cloud_watch_metrics_enabled {
        object.key("PublishCloudWatchMetricsEnabled").boolean(*var_134);
    }
    if let Some(var_135) = &input.bytes_scanned_cutoff_per_query {
        object.key("BytesScannedCutoffPerQuery").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_135).into()));
    }
...
pub fn serialize_structure_crate_model_query_execution_context(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::QueryExecutionContext) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_139) = &input.database {
        object.key("Database").string(var_139.as_str());
    }
    if let Some(var_140) = &input.catalog {
        object.key("Catalog").string(var_140.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_result_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResultConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_141) = &input.output_location {
        object.key("OutputLocation").string(var_141.as_str());
    }
    if let Some(var_142) = &input.encryption_configuration {
        let mut object_143 = object.key("EncryptionConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_encryption_configuration(&mut object_143, var_142)?;
        object_143.finish();
    }
    if let Some(var_144) = &input.expected_bucket_owner {
        object.key("ExpectedBucketOwner").string(var_144.as_str());
    }
    if let Some(var_145) = &input.acl_configuration {
        let mut object_146 = object.key("AclConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_acl_configuration(&mut object_146, var_145)?;
        object_146.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_result_reuse_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResultReuseConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_147) = &input.result_reuse_by_age_configuration {
        let mut object_148 = object.key("ResultReuseByAgeConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_result_reuse_by_age_configuration(&mut object_148, var_147)?;
        object_148.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_work_group_configuration_updates(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WorkGroupConfigurationUpdates) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_149) = &input.enforce_work_group_configuration {
        object.key("EnforceWorkGroupConfiguration").boolean(*var_149);
    }
    if let Some(var_150) = &input.result_configuration_updates {
        let mut object_151 = object.key("ResultConfigurationUpdates").start_object();
        crate::json_ser::serialize_structure_crate_model_result_configuration_updates(&mut object_151, var_150)?;
        object_151.finish();
    }
    if let Some(var_152) = &input.publish_cloud_watch_metrics_enabled {
        object.key("PublishCloudWatchMetricsEnabled").boolean(*var_152);
    }
    if let Some(var_153) = &input.bytes_scanned_cutoff_per_query {
        object.key("BytesScannedCutoffPerQuery").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_153).into()));
    }
    if let Some(var_154) = &input.remove_bytes_scanned_cutoff_per_query {
        object.key("RemoveBytesScannedCutoffPerQuery").boolean(*var_154);
    }
    if let Some(var_155) = &input.requester_pays_enabled {
        object.key("RequesterPaysEnabled").boolean(*var_155);
    }
    if let Some(var_156) = &input.engine_version {
        let mut object_157 = object.key("EngineVersion").start_object();
        crate::json_ser::serialize_structure_crate_model_engine_version(&mut object_157, var_156)?;
        object_157.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_engine_version(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EngineVersion) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_158) = &input.selected_engine_version {
        object.key("SelectedEngineVersion").string(var_158.as_str());
    }
    if let Some(var_159) = &input.effective_engine_version {
        object.key("EffectiveEngineVersion").string(var_159.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_encryption_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EncryptionConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_160) = &input.encryption_option {
        object.key("EncryptionOption").string(var_160.as_str());
    }
    if let Some(var_161) = &input.kms_key {
        object.key("KmsKey").string(var_161.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_acl_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AclConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_162) = &input.s3_acl_option {
        object.key("S3AclOption").string(var_162.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_result_reuse_by_age_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResultReuseByAgeConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_163) = &input.max_age_in_minutes {
        object.key("MaxAgeInMinutes").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_163).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_result_configuration_updates(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResultConfigurationUpdates) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_164) = &input.output_location {
        object.key("OutputLocation").string(var_164.as_str());
    }
    if let Some(var_165) = &input.remove_output_location {
        object.key("RemoveOutputLocation").boolean(*var_165);
    }
    if let Some(var_166) = &input.encryption_configuration {
        let mut object_167 = object.key("EncryptionConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_encryption_configuration(&mut object_167, var_166)?;
        object_167.finish();
    }
    if let Some(var_168) = &input.remove_encryption_configuration {
        object.key("RemoveEncryptionConfiguration").boolean(*var_168);
    }
    if let Some(var_169) = &input.expected_bucket_owner {
        object.key("ExpectedBucketOwner").string(var_169.as_str());
    }
    if let Some(var_170) = &input.remove_expected_bucket_owner {
        object.key("RemoveExpectedBucketOwner").boolean(*var_170);
    }
    if let Some(var_171) = &input.acl_configuration {
        let mut object_172 = object.key("AclConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_acl_configuration(&mut object_172, var_171)?;
        object_172.finish();
    }
    if let Some(var_173) = &input.remove_acl_configuration {
        object.key("RemoveAclConfiguration").boolean(*var_173);
    }
    Ok(())
}
