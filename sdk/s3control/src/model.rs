...
pub struct NoncurrentVersionExpiration  {
    ...
    #[doc(hidden)]pub newer_noncurrent_versions: std::option::Option<i32>,
}
...
pub struct LifecycleRuleFilter  {
    ...
    #[doc(hidden)]pub object_size_greater_than: std::option::Option<i64>,
    /// <p>Maximum object size to which the rule applies.</p>
    #[doc(hidden)]pub object_size_less_than: std::option::Option<i64>,
}
