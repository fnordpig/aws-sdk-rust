...
pub struct DescribeTaskExecutionOutput  {
    ...
    /// <p>The physical number of bytes transferred over the network after compression was applied. In most cases, this number is less than <code>BytesTransferred</code>.</p>
    #[doc(hidden)]pub bytes_compressed: i64,
}
...
impl  std::fmt::Debug for DescribeTaskExecutionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("bytes_compressed", &self.bytes_compressed);
        formatter.finish()
    }
}
