...
pub struct ComputeAttributes  {
    ...
    /// </ul>
    #[doc(hidden)]pub state: std::option::Option<crate::model::ComputeAssetState>,
}
...
impl std::convert::From<&str> for ComputeAssetState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ComputeAssetState::Unknown(other.to_owned())
        }
    }
}
...
impl ComputeAssetState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ComputeAssetState::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
