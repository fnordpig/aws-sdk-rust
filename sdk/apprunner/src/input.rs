...
impl CreateVpcIngressConnectionInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreateVpcIngressConnection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl DeleteVpcIngressConnectionInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteVpcIngressConnection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl DescribeServiceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeService, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl DescribeVpcIngressConnectionInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeVpcIngressConnection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl ListVpcIngressConnectionsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListVpcIngressConnections, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl PauseServiceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::PauseService, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl ResumeServiceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ResumeService, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl UpdateVpcIngressConnectionInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateVpcIngressConnection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
pub struct UpdateVpcIngressConnectionInput  {
    /// <p>The Amazon Resource Name (Arn) for the App Runner VPC Ingress Connection resource that you want to update.</p>
    #[doc(hidden)]pub vpc_ingress_connection_arn: std::option::Option<std::string::String>,
    /// <p>Specifications for the customer’s Amazon VPC and the related Amazon Web Services PrivateLink VPC endpoint that are used to update the VPC Ingress Connection resource.</p>
    #[doc(hidden)]pub ingress_vpc_configuration: std::option::Option<crate::model::IngressVpcConfiguration>,
}
impl UpdateVpcIngressConnectionInput {
    /// <p>The Amazon Resource Name (Arn) for the App Runner VPC Ingress Connection resource that you want to update.</p>
...
impl  std::fmt::Debug for UpdateVpcIngressConnectionInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateVpcIngressConnectionInput");
        formatter.field("vpc_ingress_connection_arn", &self.vpc_ingress_connection_arn);
        formatter.field("ingress_vpc_configuration", &self.ingress_vpc_configuration);
        formatter.finish()
    }
}
...
pub struct ListVpcIngressConnectionsInput  {
    /// <p>The VPC Ingress Connections to be listed based on either the Service Arn or Vpc Endpoint Id, or both.</p>
    #[doc(hidden)]pub filter: std::option::Option<crate::model::ListVpcIngressConnectionsFilter>,
    /// <p>The maximum number of results to include in each response (result page). It's used for a paginated request.</p> 
    /// <p>If you don't specify <code>MaxResults</code>, the request retrieves all available results in a single response.</p>
...
impl  std::fmt::Debug for ListVpcIngressConnectionsInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListVpcIngressConnectionsInput");
...
impl  std::fmt::Debug for DescribeVpcIngressConnectionInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DescribeVpcIngressConnectionInput");
        formatter.field("vpc_ingress_connection_arn", &self.vpc_ingress_connection_arn);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for DeleteVpcIngressConnectionInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeleteVpcIngressConnectionInput");
        formatter.field("vpc_ingress_connection_arn", &self.vpc_ingress_connection_arn);
        formatter.finish()
    }
}
...
pub struct CreateVpcIngressConnectionInput  {
    ...
    #[doc(hidden)]pub service_arn: std::option::Option<std::string::String>,
    /// <p>A name for the VPC Ingress Connection resource. It must be unique across all the active VPC Ingress Connections in your Amazon Web Services account in the Amazon Web Services Region. </p>
    #[doc(hidden)]pub vpc_ingress_connection_name: std::option::Option<std::string::String>,
    /// <p>Specifications for the customer’s Amazon VPC and the related Amazon Web Services PrivateLink VPC endpoint that are used to create the VPC Ingress Connection resource.</p>
    #[doc(hidden)]pub ingress_vpc_configuration: std::option::Option<crate::model::IngressVpcConfiguration>,
    /// <p>An optional list of metadata items that you can associate with the VPC Ingress Connection resource. A tag is a key-value pair.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::vec::Vec<crate::model::Tag>>,
...
impl  std::fmt::Debug for CreateVpcIngressConnectionInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CreateVpcIngressConnectionInput");
        formatter.field("service_arn", &self.service_arn);
        formatter.field("vpc_ingress_connection_name", &self.vpc_ingress_connection_name);
        formatter.field("ingress_vpc_configuration", &self.ingress_vpc_configuration);
        formatter.field("tags", &self.tags);
        formatter.finish()
    }
