...
pub struct UpdateVpcIngressConnectionOutput  {
    ...
    #[doc(hidden)]pub vpc_ingress_connection: std::option::Option<crate::model::VpcIngressConnection>,
}
...
impl  std::fmt::Debug for UpdateVpcIngressConnectionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateVpcIngressConnectionOutput");
        formatter.field("vpc_ingress_connection", &self.vpc_ingress_connection);
        formatter.finish()
    }
}
...
pub struct ListVpcIngressConnectionsOutput  {
    ...
    #[doc(hidden)]pub vpc_ingress_connection_summary_list: std::option::Option<std::vec::Vec<crate::model::VpcIngressConnectionSummary>>,
...
impl  std::fmt::Debug for ListVpcIngressConnectionsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListVpcIngressConnectionsOutput");
        formatter.field("vpc_ingress_connection_summary_list", &self.vpc_ingress_connection_summary_list);
...
pub struct DisassociateCustomDomainOutput  {
    ...
    #[doc(hidden)]pub vpc_dns_targets: std::option::Option<std::vec::Vec<crate::model::VpcDnsTarget>>,
}
...
impl  std::fmt::Debug for DisassociateCustomDomainOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("vpc_dns_targets", &self.vpc_dns_targets);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for DescribeVpcIngressConnectionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DescribeVpcIngressConnectionOutput");
        formatter.field("vpc_ingress_connection", &self.vpc_ingress_connection);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for DeleteVpcIngressConnectionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeleteVpcIngressConnectionOutput");
        formatter.field("vpc_ingress_connection", &self.vpc_ingress_connection);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for CreateVpcIngressConnectionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CreateVpcIngressConnectionOutput");
        formatter.field("vpc_ingress_connection", &self.vpc_ingress_connection);
        formatter.finish()
    }
}
