...
pub struct StackSetOperationSummary  {
    ...
    #[doc(hidden)]pub status_details: std::option::Option<crate::model::StackSetOperationStatusDetails>,
    /// <p>The user-specified preferences for how CloudFormation performs a stack set operation.</p> 
    /// <p>For more information about maximum concurrent accounts and failure tolerance, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-concepts.html#stackset-ops-options">Stack set operation options</a>.</p>
...
impl  std::fmt::Debug for StackSetOperationStatusDetails  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("StackSetOperationStatusDetails");
...
pub struct OperationResultFilter  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::OperationResultFilterName>,
...
impl  std::fmt::Debug for OperationResultFilter  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("OperationResultFilter");
...
impl std::convert::From<&str> for OperationResultFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OperationResultFilterName::Unknown(other.to_owned())
        }
    }
}
...
impl OperationResultFilterName {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            OperationResultFilterName::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct StackInstanceSummary  {
    ...
    #[doc(hidden)]pub last_operation_id: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for StackInstanceSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("drift_status", &self.drift_status);
        formatter.field("last_drift_check_timestamp", &self.last_drift_check_timestamp);
        formatter.field("last_operation_id", &self.last_operation_id);
        formatter.finish()
    }
}
