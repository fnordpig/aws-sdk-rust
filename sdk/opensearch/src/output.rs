...
impl  std::fmt::Debug for UpdateVpcEndpointOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateVpcEndpointOutput");
...
impl  std::fmt::Debug for RevokeVpcEndpointAccessOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("RevokeVpcEndpointAccessOutput");
        formatter.finish()
    }
}
...
pub struct ListVpcEndpointsForDomainOutput  {
    ...
    #[doc(hidden)]pub vpc_endpoint_summary_list: std::option::Option<std::vec::Vec<crate::model::VpcEndpointSummary>>,
...
impl  std::fmt::Debug for ListVpcEndpointsForDomainOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListVpcEndpointsForDomainOutput");
        formatter.field("vpc_endpoint_summary_list", &self.vpc_endpoint_summary_list);
...
impl  std::fmt::Debug for ListVpcEndpointsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListVpcEndpointsOutput");
        formatter.field("vpc_endpoint_summary_list", &self.vpc_endpoint_summary_list);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
...
pub struct ListVpcEndpointAccessOutput  {
    ...
    #[doc(hidden)]pub authorized_principal_list: std::option::Option<std::vec::Vec<crate::model::AuthorizedPrincipal>>,
    /// <p>When <code>nextToken</code> is returned, there are more results available. The value of <code>nextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListVpcEndpointAccessOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListVpcEndpointAccessOutput");
        formatter.field("authorized_principal_list", &self.authorized_principal_list);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct DescribeVpcEndpointsOutput  {
    ...
    #[doc(hidden)]pub vpc_endpoint_errors: std::option::Option<std::vec::Vec<crate::model::VpcEndpointError>>,
}
...
impl  std::fmt::Debug for DescribeVpcEndpointsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("vpc_endpoint_errors", &self.vpc_endpoint_errors);
        formatter.finish()
    }
}
...
pub struct DeleteVpcEndpointOutput  {
    ...
    #[doc(hidden)]pub vpc_endpoint_summary: std::option::Option<crate::model::VpcEndpointSummary>,
}
...
impl  std::fmt::Debug for DeleteVpcEndpointOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeleteVpcEndpointOutput");
        formatter.field("vpc_endpoint_summary", &self.vpc_endpoint_summary);
        formatter.finish()
    }
}
...
pub struct AuthorizeVpcEndpointAccessOutput  {
    ...
    #[doc(hidden)]pub authorized_principal: std::option::Option<crate::model::AuthorizedPrincipal>,
}
...
impl  std::fmt::Debug for AuthorizeVpcEndpointAccessOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("AuthorizeVpcEndpointAccessOutput");
        formatter.field("authorized_principal", &self.authorized_principal);
        formatter.finish()
    }
}
