...
pub struct VpcEndpoint  {
    ...
    #[doc(hidden)]pub vpc_endpoint_owner: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::VpcEndpointStatus>,
...
impl std::convert::From<&str> for VpcEndpointStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VpcEndpointStatus::Unknown(other.to_owned())
        }
    }
}
...
impl VpcEndpointStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            VpcEndpointStatus::Unknown(s) => s.as_ref()
        }
    }
...
impl  std::fmt::Debug for VpcEndpointSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("VpcEndpointSummary");
        formatter.field("vpc_endpoint_id", &self.vpc_endpoint_id);
        formatter.field("vpc_endpoint_owner", &self.vpc_endpoint_owner);
        formatter.field("domain_arn", &self.domain_arn);
        formatter.field("status", &self.status);
...
impl  std::fmt::Debug for AuthorizedPrincipal  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("AuthorizedPrincipal");
...
pub struct VpcEndpointError  {
    ...
    #[doc(hidden)]pub error_code: std::option::Option<crate::model::VpcEndpointErrorCode>,
    /// <p>A message describing the error.</p>
    #[doc(hidden)]pub error_message: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for VpcEndpointError  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("VpcEndpointError");
        formatter.field("vpc_endpoint_id", &self.vpc_endpoint_id);
...
impl std::convert::From<&str> for VpcEndpointErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VpcEndpointErrorCode::Unknown(other.to_owned())
        }
    }
}
...
impl VpcEndpointErrorCode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            VpcEndpointErrorCode::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
