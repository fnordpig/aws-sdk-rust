...
impl  std::fmt::Debug for UpdateRumMetricDefinitionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateRumMetricDefinitionOutput");
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for PutRumMetricsDestinationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("PutRumMetricsDestinationOutput");
        formatter.finish()
    }
}
...
pub struct ListRumMetricsDestinationsOutput  {
    ...
    #[doc(hidden)]pub destinations: std::option::Option<std::vec::Vec<crate::model::MetricDestinationSummary>>,
...
impl  std::fmt::Debug for ListRumMetricsDestinationsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListRumMetricsDestinationsOutput");
...
impl  std::fmt::Debug for DeleteRumMetricsDestinationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeleteRumMetricsDestinationOutput");
        formatter.finish()
    }
}
...
pub struct BatchGetRumMetricDefinitionsOutput  {
    ...
    #[doc(hidden)]pub metric_definitions: std::option::Option<std::vec::Vec<crate::model::MetricDefinition>>,
    /// <p>A token that you can use in a subsequent operation to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for BatchGetRumMetricDefinitionsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchGetRumMetricDefinitionsOutput");
...
pub struct BatchDeleteRumMetricDefinitionsOutput  {
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::BatchDeleteRumMetricDefinitionsError>>,
...
impl  std::fmt::Debug for BatchDeleteRumMetricDefinitionsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchDeleteRumMetricDefinitionsOutput");
...
pub struct BatchCreateRumMetricDefinitionsOutput  {
    /// <p>An array of error objects, if the operation caused any errors.</p>
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::BatchCreateRumMetricDefinitionsError>>,
...
impl  std::fmt::Debug for BatchCreateRumMetricDefinitionsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchCreateRumMetricDefinitionsOutput");
        formatter.field("errors", &self.errors);
        formatter.field("metric_definitions", &self.metric_definitions);
        formatter.finish()
    }
