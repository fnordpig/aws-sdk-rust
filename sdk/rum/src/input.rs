...
impl BatchDeleteRumMetricDefinitionsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::BatchDeleteRumMetricDefinitions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            ...
            fn uri_query(_input: &crate::input::BatchDeleteRumMetricDefinitionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_3) = &_input.destination {
                ...
                if let Some(inner_5) = &_input.metric_definition_ids {
...
impl BatchGetRumMetricDefinitionsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::BatchGetRumMetricDefinitions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            ...
            fn uri_query(_input: &crate::input::BatchGetRumMetricDefinitionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_8) = &_input.destination {
...
impl CreateAppMonitorInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreateAppMonitor, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl DeleteAppMonitorInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteAppMonitor, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl DeleteRumMetricsDestinationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteRumMetricsDestination, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            ...
            fn uri_query(_input: &crate::input::DeleteRumMetricsDestinationInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_14) = &_input.destination {
...
impl GetAppMonitorInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetAppMonitor, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl ListAppMonitorsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListAppMonitors, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl ListRumMetricsDestinationsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListRumMetricsDestinations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl PutRumEventsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::PutRumEvents, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl PutRumMetricsDestinationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::PutRumMetricsDestination, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl UpdateAppMonitorInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateAppMonitor, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
impl UpdateRumMetricDefinitionInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateRumMetricDefinition, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
...
pub struct UpdateRumMetricDefinitionInput  {
    /// <p>The name of the CloudWatch RUM app monitor that sends these metrics.</p>
    #[doc(hidden)]pub app_monitor_name: std::option::Option<std::string::String>,
    /// <p>The destination to send the metrics to. Valid values are <code>CloudWatch</code> and <code>Evidently</code>. If you specify <code>Evidently</code>, you must also specify the ARN of the CloudWatchEvidently experiment that will receive the metrics and an IAM role that has permission to write to the experiment.</p>
    #[doc(hidden)]pub destination: std::option::Option<crate::model::MetricDestination>,
    /// <p>This parameter is required if <code>Destination</code> is <code>Evidently</code>. If <code>Destination</code> is <code>CloudWatch</code>, do not use this parameter.</p> 
    /// <p>This parameter specifies the ARN of the Evidently experiment that is to receive the metrics. You must have already defined this experiment as a valid destination. For more information, see <a href="https://docs.aws.amazon.com/cloudwatchrum/latest/APIReference/API_PutRumMetricsDestination.html">PutRumMetricsDestination</a>.</p>
    #[doc(hidden)]pub destination_arn: std::option::Option<std::string::String>,
    /// <p>A structure that contains the new definition that you want to use for this metric.</p>
    #[doc(hidden)]pub metric_definition: std::option::Option<crate::model::MetricDefinitionRequest>,
    /// <p>The ID of the metric definition to update.</p>
    #[doc(hidden)]pub metric_definition_id: std::option::Option<std::string::String>,
}
impl UpdateRumMetricDefinitionInput {
    /// <p>The name of the CloudWatch RUM app monitor that sends these metrics.</p>
...
impl  std::fmt::Debug for UpdateRumMetricDefinitionInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateRumMetricDefinitionInput");
        formatter.field("app_monitor_name", &self.app_monitor_name);
        formatter.field("destination", &self.destination);
        formatter.field("destination_arn", &self.destination_arn);
        formatter.field("metric_definition", &self.metric_definition);
        formatter.field("metric_definition_id", &self.metric_definition_id);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for PutRumMetricsDestinationInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("PutRumMetricsDestinationInput");
        formatter.field("app_monitor_name", &self.app_monitor_name);
        formatter.field("destination", &self.destination);
        formatter.field("destination_arn", &self.destination_arn);
...
impl  std::fmt::Debug for ListRumMetricsDestinationsInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListRumMetricsDestinationsInput");
        formatter.field("app_monitor_name", &self.app_monitor_name);
...
impl  std::fmt::Debug for DeleteRumMetricsDestinationInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeleteRumMetricsDestinationInput");
        formatter.field("app_monitor_name", &self.app_monitor_name);
        formatter.field("destination", &self.destination);
        formatter.field("destination_arn", &self.destination_arn);
        formatter.finish()
...
impl  std::fmt::Debug for BatchGetRumMetricDefinitionsInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchGetRumMetricDefinitionsInput");
        formatter.field("app_monitor_name", &self.app_monitor_name);
        formatter.field("destination", &self.destination);
        formatter.field("destination_arn", &self.destination_arn);
        formatter.field("max_results", &self.max_results);
...
pub struct BatchDeleteRumMetricDefinitionsInput  {
    ...
    #[doc(hidden)]pub destination_arn: std::option::Option<std::string::String>,
    /// <p>An array of structures which define the metrics that you want to stop sending.</p>
    #[doc(hidden)]pub metric_definition_ids: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl BatchDeleteRumMetricDefinitionsInput {
    /// <p>The name of the CloudWatch RUM app monitor that is sending these metrics.</p>
    pub fn app_monitor_name(&self) -> std::option::Option<& str> {
...
impl  std::fmt::Debug for BatchDeleteRumMetricDefinitionsInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchDeleteRumMetricDefinitionsInput");
        formatter.field("app_monitor_name", &self.app_monitor_name);
        formatter.field("destination", &self.destination);
        formatter.field("destination_arn", &self.destination_arn);
        formatter.field("metric_definition_ids", &self.metric_definition_ids);
        formatter.finish()
    }
}
...
pub struct BatchCreateRumMetricDefinitionsInput  {
    ...
    #[doc(hidden)]pub destination_arn: std::option::Option<std::string::String>,
    /// <p>An array of structures which define the metrics that you want to send.</p>
    #[doc(hidden)]pub metric_definitions: std::option::Option<std::vec::Vec<crate::model::MetricDefinitionRequest>>,
}
impl BatchCreateRumMetricDefinitionsInput {
    /// <p>The name of the CloudWatch RUM app monitor that is to send the metrics.</p>
    pub fn app_monitor_name(&self) -> std::option::Option<& str> {
...
impl  std::fmt::Debug for BatchCreateRumMetricDefinitionsInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchCreateRumMetricDefinitionsInput");
        formatter.field("app_monitor_name", &self.app_monitor_name);
        formatter.field("destination", &self.destination);
        formatter.field("destination_arn", &self.destination_arn);
