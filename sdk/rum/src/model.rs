...
pub struct MetricDefinitionRequest  {
    ...
    #[doc(hidden)]pub dimension_keys: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
...
impl  std::fmt::Debug for MetricDefinitionRequest  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("MetricDefinitionRequest");
        formatter.field("name", &self.name);
        formatter.field("value_key", &self.value_key);
        formatter.field("unit_label", &self.unit_label);
        formatter.field("dimension_keys", &self.dimension_keys);
...
impl std::convert::From<&str> for MetricDestination {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MetricDestination::Unknown(other.to_owned())
        }
    }
}
...
impl MetricDestination {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            MetricDestination::Unknown(s) => s.as_ref()
        }
    }
...
impl  std::fmt::Debug for MetricDestinationSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("MetricDestinationSummary");
...
pub struct AppMonitorConfiguration  {
    ...
    #[doc(hidden)]pub session_sample_rate: f64,
    ...
    #[doc(hidden)]pub guest_role_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub allow_cookies: std::option::Option<bool>,
    ...
    /// </ul>
    #[doc(hidden)]pub telemetries: std::option::Option<std::vec::Vec<crate::model::Telemetry>>,
    ...
    #[doc(hidden)]pub enable_x_ray: std::option::Option<bool>,
}
...
impl  std::fmt::Debug for BatchDeleteRumMetricDefinitionsError  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchDeleteRumMetricDefinitionsError");
        formatter.field("metric_definition_id", &self.metric_definition_id);
...
impl  std::fmt::Debug for BatchCreateRumMetricDefinitionsError  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchCreateRumMetricDefinitionsError");
...
pub struct AppMonitorSummary  {
    ...
    #[doc(hidden)]pub created: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::StateEnum>,
}
...
pub struct AppMonitor  {
    ...
    #[doc(hidden)]pub data_storage: std::option::Option<crate::model::DataStorage>,
}
impl AppMonitor {
    /// <p>The name of the app monitor.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct DataStorage  {
    ...
    #[doc(hidden)]pub cw_log: std::option::Option<crate::model::CwLog>,
}
impl DataStorage {
    /// <p>A structure that contains the information about whether the app monitor stores copies of the data that RUM collects in CloudWatch Logs. If it does, this structure also contains the name of the log group.</p>
...
pub struct CwLog  {
    ...
    #[doc(hidden)]pub cw_log_group: std::option::Option<std::string::String>,
}
impl CwLog {
    /// <p>Indicated whether the app monitor stores copies of the data that RUM collects in CloudWatch Logs.</p>
