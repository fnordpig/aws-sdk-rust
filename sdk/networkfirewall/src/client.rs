...
impl Client  {
    ...
    ///   - [`delete_protection(Option<bool>)`](crate::output::UpdateFirewallDeleteProtectionOutput::delete_protection): <p>A flag indicating whether it is possible to delete the firewall. A setting of <code>TRUE</code> indicates that the firewall is protected against deletion. Use this setting to protect against accidentally deleting a firewall that is in use. When you create a firewall, the operation initializes this flag to <code>TRUE</code>.</p>
    ...
    ///   - [`firewall_policy_change_protection(Option<bool>)`](crate::output::UpdateFirewallPolicyChangeProtectionOutput::firewall_policy_change_protection): <p>A setting indicating whether the firewall is protected against a change to the firewall policy association. Use this setting to protect against accidentally modifying the firewall policy for a firewall that is in use. When you create a firewall, the operation initializes this setting to <code>TRUE</code>.</p>
