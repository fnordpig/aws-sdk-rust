...
pub fn serialize_union_crate_model_idp_metadata(object_64: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IdpMetadata) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
