...
pub struct SnsTopicConfiguration  {
    ...
    #[doc(hidden)]pub topic_policy: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for SnsTopicConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("SnsTopicConfiguration");
...
pub struct RdsDbSnapshotConfiguration  {
    ...
    #[doc(hidden)]pub attributes: std::option::Option<std::collections::HashMap<std::string::String, crate::model::RdsDbSnapshotAttributeValue>>,
...
impl  std::fmt::Debug for RdsDbSnapshotConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("RdsDbSnapshotConfiguration");
...
impl RdsDbSnapshotAttributeValue {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`AccountIds`](crate::model::RdsDbSnapshotAttributeValue::AccountIds), extracting the inner [`Vec`](std::vec::Vec).
    /// Returns `Err(&Self)` if it can't be converted.
...
pub struct RdsDbClusterSnapshotConfiguration  {
    ...
    #[doc(hidden)]pub attributes: std::option::Option<std::collections::HashMap<std::string::String, crate::model::RdsDbClusterSnapshotAttributeValue>>,
...
impl  std::fmt::Debug for RdsDbClusterSnapshotConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("RdsDbClusterSnapshotConfiguration");
        formatter.field("attributes", &self.attributes);
        formatter.field("kms_key_id", &self.kms_key_id);
        formatter.finish()
    }
...
impl RdsDbClusterSnapshotAttributeValue {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`AccountIds`](crate::model::RdsDbClusterSnapshotAttributeValue::AccountIds), extracting the inner [`Vec`](std::vec::Vec).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_account_ids(&self) -> std::result::Result<&std::vec::Vec<std::string::String>, &Self> {
...
pub struct EfsFileSystemConfiguration  {
    ...
    #[doc(hidden)]pub file_system_policy: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for EfsFileSystemConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("EfsFileSystemConfiguration");
        formatter.field("file_system_policy", &self.file_system_policy);
        formatter.finish()
    }
}
...
pub struct EcrRepositoryConfiguration  {
    ...
    #[doc(hidden)]pub repository_policy: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for EcrRepositoryConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("EcrRepositoryConfiguration");
        formatter.field("repository_policy", &self.repository_policy);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for EbsSnapshotConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("EbsSnapshotConfiguration");
