...
pub struct SlackWorkspaceConfiguration  {
    ...
    #[doc(hidden)]pub team_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub allow_organization_member_account: std::option::Option<bool>,
}
...
impl  std::fmt::Debug for SlackWorkspaceConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("team_name", &self.team_name);
        formatter.field("allow_organization_member_account", &self.allow_organization_member_account);
        formatter.finish()
    }
}
