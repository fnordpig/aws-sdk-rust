...
pub struct CreateDetectorOutput  {
    ...
    #[doc(hidden)]pub unprocessed_data_sources: std::option::Option<crate::model::UnprocessedDataSourcesResult>,
}
...
impl  std::fmt::Debug for CreateDetectorOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("unprocessed_data_sources", &self.unprocessed_data_sources);
        formatter.finish()
    }
}
