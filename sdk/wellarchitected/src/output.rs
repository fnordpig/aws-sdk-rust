...
pub struct ListCheckSummariesOutput  {
    ...
    #[doc(hidden)]pub check_summaries: std::option::Option<std::vec::Vec<crate::model::CheckSummary>>,
    /// <p>The token to use to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListCheckSummariesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListCheckSummariesOutput");
        formatter.field("check_summaries", &self.check_summaries);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct ListCheckDetailsOutput  {
    ...
    #[doc(hidden)]pub check_details: std::option::Option<std::vec::Vec<crate::model::CheckDetail>>,
    /// <p>The token to use to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListCheckDetailsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListCheckDetailsOutput");
        formatter.field("check_details", &self.check_details);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
