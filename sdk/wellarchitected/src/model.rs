...
pub struct WorkloadShare  {
    ...
    #[doc(hidden)]pub shared_by: std::option::Option<std::string::String>,
...
pub struct Workload  {
    ...
    /// <p>The date and time recorded.</p>
    #[doc(hidden)]pub review_restriction_date: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub risk_counts: std::option::Option<std::collections::HashMap<crate::model::Risk, i32>>,
    ...
    #[doc(hidden)]pub discovery_config: std::option::Option<crate::model::WorkloadDiscoveryConfig>,
...
impl  std::fmt::Debug for Workload  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("discovery_config", &self.discovery_config);
...
pub struct WorkloadDiscoveryConfig  {
    ...
    #[doc(hidden)]pub trusted_advisor_integration_status: std::option::Option<crate::model::TrustedAdvisorIntegrationStatus>,
}
...
impl  std::fmt::Debug for WorkloadDiscoveryConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("WorkloadDiscoveryConfig");
        formatter.field("trusted_advisor_integration_status", &self.trusted_advisor_integration_status);
        formatter.finish()
    }
}
...
impl std::convert::From<&str> for TrustedAdvisorIntegrationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrustedAdvisorIntegrationStatus::Unknown(other.to_owned())
        }
    }
}
...
impl TrustedAdvisorIntegrationStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            TrustedAdvisorIntegrationStatus::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct LensReview  {
    ...
    #[doc(hidden)]pub lens_status: std::option::Option<crate::model::LensStatus>,
    /// <p>List of pillar review summaries of lens review in a workload.</p>
    #[doc(hidden)]pub pillar_review_summaries: std::option::Option<std::vec::Vec<crate::model::PillarReviewSummary>>,
    /// <p>The date and time recorded.</p>
    #[doc(hidden)]pub updated_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The notes associated with the workload.</p>
    #[doc(hidden)]pub notes: std::option::Option<std::string::String>,
...
pub struct PillarReviewSummary  {
    ...
    #[doc(hidden)]pub pillar_name: std::option::Option<std::string::String>,
    /// <p>The notes associated with the workload.</p>
    #[doc(hidden)]pub notes: std::option::Option<std::string::String>,
    /// <p>A map from risk names to the count of how questions have that rating.</p>
    #[doc(hidden)]pub risk_counts: std::option::Option<std::collections::HashMap<crate::model::Risk, i32>>,
...
pub struct Answer  {
    ...
    #[doc(hidden)]pub question_title: std::option::Option<std::string::String>,
    /// <p>The description of the question.</p>
    #[doc(hidden)]pub question_description: std::option::Option<std::string::String>,
    /// <p>The improvement plan URL for a question.</p> 
    /// <p>This value is only available if the question has been answered.</p>
    #[doc(hidden)]pub improvement_plan_url: std::option::Option<std::string::String>,
    /// <p>The helpful resource URL for a question.</p>
    #[doc(hidden)]pub helpful_resource_url: std::option::Option<std::string::String>,
    /// <p>The helpful resource text to be displayed.</p>
    #[doc(hidden)]pub helpful_resource_display_text: std::option::Option<std::string::String>,
    /// <p>List of choices available for a question.</p>
    #[doc(hidden)]pub choices: std::option::Option<std::vec::Vec<crate::model::Choice>>,
    ...
    #[doc(hidden)]pub choice_answers: std::option::Option<std::vec::Vec<crate::model::ChoiceAnswer>>,
    /// <p>Defines whether this question is applicable to a lens review.</p>
    #[doc(hidden)]pub is_applicable: bool,
    /// <p>The risk for a given workload, lens review, pillar, or question.</p>
    #[doc(hidden)]pub risk: std::option::Option<crate::model::Risk>,
    /// <p>The notes associated with the workload.</p>
    #[doc(hidden)]pub notes: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for Answer  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("helpful_resource_display_text", &self.helpful_resource_display_text);
...
pub struct ChoiceAnswer  {
    ...
    #[doc(hidden)]pub choice_id: std::option::Option<std::string::String>,
    /// <p>The status of a choice.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ChoiceStatus>,
    /// <p>The reason why a choice is non-applicable to a question in your workload.</p>
    #[doc(hidden)]pub reason: std::option::Option<crate::model::ChoiceReason>,
...
pub struct Choice  {
    ...
    #[doc(hidden)]pub helpful_resource: std::option::Option<crate::model::ChoiceContent>,
    /// <p>The choice level improvement plan.</p>
    #[doc(hidden)]pub improvement_plan: std::option::Option<crate::model::ChoiceContent>,
    ...
    #[doc(hidden)]pub additional_resources: std::option::Option<std::vec::Vec<crate::model::AdditionalResources>>,
}
impl Choice {
    /// <p>The ID of a choice.</p>
    pub fn choice_id(&self) -> std::option::Option<& str> {
...
pub struct AdditionalResources  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::AdditionalResourceType>,
    ...
    #[doc(hidden)]pub content: std::option::Option<std::vec::Vec<crate::model::ChoiceContent>>,
}
...
pub struct ChoiceContent  {
    ...
    #[doc(hidden)]pub display_text: std::option::Option<std::string::String>,
...
pub struct NotificationSummary  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::NotificationType>,
    /// <p>Summary of lens upgrade.</p>
    #[doc(hidden)]pub lens_upgrade_summary: std::option::Option<crate::model::LensUpgradeSummary>,
}
...
pub struct LensUpgradeSummary  {
    ...
    #[doc(hidden)]pub current_lens_version: std::option::Option<std::string::String>,
...
pub struct MilestoneSummary  {
    ...
    /// <p>The date and time recorded.</p>
    #[doc(hidden)]pub recorded_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>A workload summary return object.</p>
    #[doc(hidden)]pub workload_summary: std::option::Option<crate::model::WorkloadSummary>,
}
...
pub struct ImprovementSummary  {
    ...
    #[doc(hidden)]pub improvement_plans: std::option::Option<std::vec::Vec<crate::model::ChoiceImprovementPlan>>,
}
...
pub struct CheckSummary  {
    ...
    #[doc(hidden)]pub provider: std::option::Option<crate::model::CheckProvider>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::CheckStatus>,
    /// <p>Account summary associated to the check.</p>
    #[doc(hidden)]pub account_summary: std::option::Option<std::collections::HashMap<crate::model::CheckStatus, i32>>,
}
impl CheckSummary {
    /// <p>Trusted Advisor check ID.</p>
...
impl  std::fmt::Debug for CheckSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CheckSummary");
        ...
        formatter.field("choice_id", &self.choice_id);
        formatter.field("status", &self.status);
        formatter.field("account_summary", &self.account_summary);
        formatter.finish()
    }
}
...
impl std::convert::From<&str> for CheckStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CheckStatus::Unknown(other.to_owned())
        }
    }
}
...
impl CheckStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            CheckStatus::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for CheckProvider {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CheckProvider::Unknown(other.to_owned())
        }
    }
}
...
impl CheckProvider {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            CheckProvider::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct CheckDetail  {
    ...
    #[doc(hidden)]pub flagged_resources: i32,
    /// <p>Reason associated to the check.</p>
    #[doc(hidden)]pub reason: std::option::Option<crate::model::CheckFailureReason>,
    /// <p>The date and time recorded.</p>
    #[doc(hidden)]pub updated_at: std::option::Option<aws_smithy_types::DateTime>,
}
impl CheckDetail {
...
impl  std::fmt::Debug for CheckDetail  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CheckDetail");
        formatter.field("id", &self.id);
        formatter.field("name", &self.name);
        formatter.field("description", &self.description);
        formatter.field("provider", &self.provider);
...
impl std::convert::From<&str> for CheckFailureReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CheckFailureReason::Unknown(other.to_owned())
        }
    }
}
...
impl CheckFailureReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            CheckFailureReason::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct AnswerSummary  {
    ...
    #[doc(hidden)]pub selected_choices: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>A list of selected choices to a question in your workload.</p>
    #[doc(hidden)]pub choice_answer_summaries: std::option::Option<std::vec::Vec<crate::model::ChoiceAnswerSummary>>,
    /// <p>Defines whether this question is applicable to a lens review.</p>
    #[doc(hidden)]pub is_applicable: bool,
    /// <p>The risk for a given workload, lens review, pillar, or question.</p>
    #[doc(hidden)]pub risk: std::option::Option<crate::model::Risk>,
...
pub struct VersionDifferences  {
    /// <p>The differences between the base and latest versions of the lens.</p>
    #[doc(hidden)]pub pillar_differences: std::option::Option<std::vec::Vec<crate::model::PillarDifference>>,
}
...
pub struct PillarDifference  {
    ...
    #[doc(hidden)]pub difference_status: std::option::Option<crate::model::DifferenceStatus>,
    /// <p>List of question differences.</p>
    #[doc(hidden)]pub question_differences: std::option::Option<std::vec::Vec<crate::model::QuestionDifference>>,
}
...
pub struct LensReviewReport  {
    ...
    #[doc(hidden)]pub base64_string: std::option::Option<std::string::String>,
}
