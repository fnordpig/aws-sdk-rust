...
pub fn serialize_union_crate_model_job_driver(object_28: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::JobDriver) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
