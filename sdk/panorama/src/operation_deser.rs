...
#[allow(clippy::unnecessary_wraps)]pub fn parse_signal_application_instance_node_instances_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SignalApplicationInstanceNodeInstancesOutput, crate::error::SignalApplicationInstanceNodeInstancesError> {
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_signal_application_instance_node_instances_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SignalApplicationInstanceNodeInstancesOutput, crate::error::SignalApplicationInstanceNodeInstancesError> {
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::signal_application_instance_node_instances_output::Builder::default();
        let _ = response;
