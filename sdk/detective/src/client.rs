...
impl Client  {
    ...
    pub fn batch_get_graph_member_datasources(&self) -> fluent_builders::BatchGetGraphMemberDatasources {
    ...
    pub fn batch_get_membership_datasources(&self) -> fluent_builders::BatchGetMembershipDatasources {
