...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_describe_certificates(inp: &[u8], mut builder: crate::output::describe_certificates_output::Builder) -> Result<crate::output::describe_certificates_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
