...
pub struct InstanceRequirements  {
    ...
    /// <p>Default: No minimum or maximum limits</p>
    #[doc(hidden)]pub network_bandwidth_gbps: std::option::Option<crate::model::NetworkBandwidthGbpsRequest>,
    ...
    #[doc(hidden)]pub allowed_instance_types: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
impl  std::fmt::Debug for InstanceRequirements  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("network_bandwidth_gbps", &self.network_bandwidth_gbps);
        formatter.field("allowed_instance_types", &self.allowed_instance_types);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for NetworkBandwidthGbpsRequest  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("NetworkBandwidthGbpsRequest");
