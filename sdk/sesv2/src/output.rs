...
impl  std::fmt::Debug for PutConfigurationSetVdmOptionsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("PutConfigurationSetVdmOptionsOutput");
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for PutAccountVdmAttributesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("PutAccountVdmAttributesOutput");
        formatter.finish()
    }
}
...
pub struct GetDedicatedIpPoolOutput  {
    ...
    #[doc(hidden)]pub dedicated_ip_pool: std::option::Option<crate::model::DedicatedIpPool>,
}
...
impl  std::fmt::Debug for GetDedicatedIpPoolOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetDedicatedIpPoolOutput");
        formatter.field("dedicated_ip_pool", &self.dedicated_ip_pool);
        formatter.finish()
    }
}
...
pub struct BatchGetMetricDataOutput  {
    ...
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::MetricDataResult>>,
    /// <p>A list of <code>MetricDataError</code> encountered while processing your metric data batch request.</p>
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::MetricDataError>>,
}
...
impl  std::fmt::Debug for BatchGetMetricDataOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchGetMetricDataOutput");
