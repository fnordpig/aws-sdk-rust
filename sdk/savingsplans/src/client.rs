...
impl Client  {
    ...
    pub fn describe_savings_plans_offering_rates(&self) -> fluent_builders::DescribeSavingsPlansOfferingRates {
    ...
    pub fn describe_savings_plans_offerings(&self) -> fluent_builders::DescribeSavingsPlansOfferings {
