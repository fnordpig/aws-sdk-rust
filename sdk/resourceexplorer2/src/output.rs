...
impl  std::fmt::Debug for AssociateDefaultViewOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("AssociateDefaultViewOutput");
...
pub struct ListViewsOutput  {
    ...
    #[doc(hidden)]pub views: std::option::Option<std::vec::Vec<std::string::String>>,
...
impl  std::fmt::Debug for ListViewsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListViewsOutput");
        formatter.field("views", &self.views);
...
pub struct CreateViewOutput  {
    ...
    #[doc(hidden)]pub view: std::option::Option<crate::model::View>,
}
...
impl  std::fmt::Debug for CreateViewOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CreateViewOutput");
...
impl  std::fmt::Debug for DeleteViewOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeleteViewOutput");
        formatter.field("view_arn", &self.view_arn);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for UpdateViewOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateViewOutput");
        formatter.field("view", &self.view);
        formatter.finish()
    }
}
...
pub struct ListIndexesOutput  {
    ...
    #[doc(hidden)]pub indexes: std::option::Option<std::vec::Vec<crate::model::Index>>,
    /// <p>If present, indicates that more output is available than is included in the current response. Use this value in the <code>NextToken</code> request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the <code>NextToken</code> response element comes back as <code>null</code>.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListIndexesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListIndexesOutput");
        formatter.field("indexes", &self.indexes);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct CreateIndexOutput  {
    ...
    /// </note>
    #[doc(hidden)]pub state: std::option::Option<crate::model::IndexState>,
...
impl  std::fmt::Debug for UpdateIndexTypeOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateIndexTypeOutput");
        formatter.field("arn", &self.arn);
...
pub struct SearchOutput  {
    ...
    #[doc(hidden)]pub count: std::option::Option<crate::model::ResourceCount>,
}
impl SearchOutput {
    /// <p>The list of structures that describe the resources that match the query.</p>
...
pub struct ListSupportedResourceTypesOutput  {
    ...
    #[doc(hidden)]pub resource_types: std::option::Option<std::vec::Vec<crate::model::SupportedResourceType>>,
    /// <p>If present, indicates that more output is available than is included in the current response. Use this value in the <code>NextToken</code> request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the <code>NextToken</code> response element comes back as <code>null</code>.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListSupportedResourceTypesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListSupportedResourceTypesOutput");
...
pub struct GetIndexOutput  {
    ...
    #[doc(hidden)]pub arn: std::option::Option<std::string::String>,
    /// <p>Specifies the type of the index in this Region. For information about the aggregator index and how it differs from a local index, see <a href="https://docs.aws.amazon.com/resource-explorer/latest/userguide/manage-aggregator-region.html">Turning on cross-Region search by creating an aggregator index</a>.</p>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::IndexType>,
    /// <p>Indicates the current state of the index in this Amazon Web Services Region.</p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::IndexState>,
    /// <p>If this index is <code>Type=AGGREGATOR</code>, then this response value contains a list of the Amazon Web Services Regions that replicate their content to the index in this Region. Not present for a local index.</p>
    #[doc(hidden)]pub replicating_from: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Identifies the Amazon Web Services Region that has an index set to <code>Type=AGGREGATOR</code>, if one exists. If it does, then the Region you called this operation in replicates its index information to the Region specified in this response value. Not present if there isn't an aggregator index in the account.</p>
    #[doc(hidden)]pub replicating_to: std::option::Option<std::vec::Vec<std::string::String>>,
...
impl  std::fmt::Debug for GetDefaultViewOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetDefaultViewOutput");
        formatter.field("view_arn", &self.view_arn);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for DisassociateDefaultViewOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DisassociateDefaultViewOutput");
        formatter.finish()
    }
}
...
pub struct BatchGetViewOutput  {
    ...
    #[doc(hidden)]pub views: std::option::Option<std::vec::Vec<crate::model::View>>,
    /// <p>If any of the specified ARNs result in an error, then this structure describes the error.</p>
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::BatchGetViewError>>,
}
...
impl  std::fmt::Debug for BatchGetViewOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchGetViewOutput");
        formatter.field("views", &self.views);
