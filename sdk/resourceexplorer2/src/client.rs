...
impl Client  {
    ...
    ///   - [`r#type(Option<IndexType>)`](crate::output::GetIndexOutput::type): <p>Specifies the type of the index in this Region. For information about the aggregator index and how it differs from a local index, see <a href="https://docs.aws.amazon.com/resource-explorer/latest/userguide/manage-aggregator-region.html">Turning on cross-Region search by creating an aggregator index</a>.</p>
    ///   - [`state(Option<IndexState>)`](crate::output::GetIndexOutput::state): <p>Indicates the current state of the index in this Amazon Web Services Region.</p>
    ///   - [`replicating_from(Option<Vec<String>>)`](crate::output::GetIndexOutput::replicating_from): <p>If this index is <code>Type=AGGREGATOR</code>, then this response value contains a list of the Amazon Web Services Regions that replicate their content to the index in this Region. Not present for a local index.</p>
    ///   - [`replicating_to(Option<Vec<String>>)`](crate::output::GetIndexOutput::replicating_to): <p>Identifies the Amazon Web Services Region that has an index set to <code>Type=AGGREGATOR</code>, if one exists. If it does, then the Region you called this operation in replicates its index information to the Region specified in this response value. Not present if there isn't an aggregator index in the account.</p>
