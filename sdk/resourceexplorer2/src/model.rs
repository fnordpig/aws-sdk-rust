...
pub struct ValidationExceptionField  {
    ...
    #[doc(hidden)]pub validation_issue: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ValidationExceptionField  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("validation_issue", &self.validation_issue);
        formatter.finish()
    }
}
...
pub struct SearchFilter  {
    ...
    #[doc(hidden)]pub filter_string: std::option::Option<std::string::String>,
}
impl SearchFilter {
    /// <p>The string that contains the search keywords, prefixes, and operators to control the results that can be returned by a <code>Search</code> operation. For more details, see <a href="https://docs.aws.amazon.com/resource-explorer/latest/APIReference/about-query-syntax.html">Search query syntax</a>.</p>
...
impl  std::fmt::Debug for IncludedProperty  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("IncludedProperty");
        formatter.field("name", &self.name);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for Index  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("Index");
...
impl std::convert::From<&str> for IndexState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IndexState::Unknown(other.to_owned())
        }
    }
}
...
pub struct ResourceCount  {
    ...
    #[doc(hidden)]pub total_resources: std::option::Option<i64>,
    ...
    /// </ul>
    #[doc(hidden)]pub complete: std::option::Option<bool>,
}
impl ResourceCount {
    /// <p>The number of resources that match the search query. This value can't exceed 1,000. If there are more than 1,000 resources that match the query, then only 1,000 are counted and the <code>Complete</code> field is set to false. We recommend that you refine your query to return a smaller number of results.</p>
...
pub struct Resource  {
    ...
    #[doc(hidden)]pub last_reported_at: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub properties: std::option::Option<std::vec::Vec<crate::model::ResourceProperty>>,
}
impl Resource {
    /// <p>The <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon resource name (ARN)</a> of the resource.</p>
    pub fn arn(&self) -> std::option::Option<& str> {
...
impl  std::fmt::Debug for Resource  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("last_reported_at", &self.last_reported_at);
...
pub struct ResourceProperty  {
    ...
    #[doc(hidden)]pub data: std::option::Option<aws_smithy_types::Document>,
}
...
impl  std::fmt::Debug for ResourceProperty  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ResourceProperty");
        formatter.field("name", &self.name);
        formatter.field("last_reported_at", &self.last_reported_at);
...
impl  std::fmt::Debug for SupportedResourceType  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("SupportedResourceType");
        formatter.field("service", &self.service);
        formatter.field("resource_type", &self.resource_type);
        formatter.finish()
    }
...
impl  std::fmt::Debug for BatchGetViewError  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchGetViewError");
        formatter.field("view_arn", &self.view_arn);
