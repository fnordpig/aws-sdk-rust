...
pub struct ListSatellitesOutput  {
    ...
    #[doc(hidden)]pub satellites: std::option::Option<std::vec::Vec<crate::model::SatelliteListItem>>,
}
...
pub struct ListMissionProfilesOutput  {
    ...
    #[doc(hidden)]pub mission_profile_list: std::option::Option<std::vec::Vec<crate::model::MissionProfileListItem>>,
}
...
pub struct ListGroundStationsOutput  {
    ...
    #[doc(hidden)]pub ground_station_list: std::option::Option<std::vec::Vec<crate::model::GroundStationData>>,
}
...
pub struct ListEphemeridesOutput  {
    ...
    #[doc(hidden)]pub ephemerides: std::option::Option<std::vec::Vec<crate::model::EphemerisItem>>,
}
...
impl  std::fmt::Debug for ListEphemeridesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListEphemeridesOutput");
        formatter.field("next_token", &self.next_token);
        formatter.field("ephemerides", &self.ephemerides);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for CreateEphemerisOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CreateEphemerisOutput");
...
impl  std::fmt::Debug for DeleteEphemerisOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeleteEphemerisOutput");
        formatter.field("ephemeris_id", &self.ephemeris_id);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for UpdateEphemerisOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateEphemerisOutput");
        formatter.field("ephemeris_id", &self.ephemeris_id);
        formatter.finish()
    }
}
...
pub struct DescribeEphemerisOutput  {
    ...
    #[doc(hidden)]pub supplied_data: std::option::Option<crate::model::EphemerisTypeDescription>,
    /// <p>Reason that an ephemeris failed validation. Only provided for ephemerides with <code>INVALID</code> status.</p>
    #[doc(hidden)]pub invalid_reason: std::option::Option<crate::model::EphemerisInvalidReason>,
}
...
impl  std::fmt::Debug for DescribeEphemerisOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DescribeEphemerisOutput");
        formatter.field("ephemeris_id", &self.ephemeris_id);
        formatter.field("satellite_id", &self.satellite_id);
        ...
        formatter.field("name", &self.name);
        formatter.field("tags", &self.tags);
        formatter.field("supplied_data", &self.supplied_data);
        formatter.field("invalid_reason", &self.invalid_reason);
        formatter.finish()
    }
}
...
pub struct ListDataflowEndpointGroupsOutput  {
    ...
    #[doc(hidden)]pub dataflow_endpoint_group_list: std::option::Option<std::vec::Vec<crate::model::DataflowEndpointListItem>>,
}
...
impl  std::fmt::Debug for ListDataflowEndpointGroupsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("next_token", &self.next_token);
        formatter.field("dataflow_endpoint_group_list", &self.dataflow_endpoint_group_list);
        formatter.finish()
    }
}
...
pub struct GetDataflowEndpointGroupOutput  {
    ...
    #[doc(hidden)]pub endpoints_details: std::option::Option<std::vec::Vec<crate::model::EndpointDetails>>,
...
pub struct ListContactsOutput  {
    ...
    #[doc(hidden)]pub contact_list: std::option::Option<std::vec::Vec<crate::model::ContactData>>,
}
...
pub struct DescribeContactOutput  {
    ...
    #[doc(hidden)]pub dataflow_list: std::option::Option<std::vec::Vec<crate::model::DataflowDetail>>,
}
...
pub struct ListConfigsOutput  {
    ...
    #[doc(hidden)]pub config_list: std::option::Option<std::vec::Vec<crate::model::ConfigListItem>>,
}
...
impl  std::fmt::Debug for GetMinuteUsageOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("is_reserved_minutes_customer", &self.is_reserved_minutes_customer);
        formatter.field("total_reserved_minute_allocation", &self.total_reserved_minute_allocation);
        formatter.field("upcoming_minutes_scheduled", &self.upcoming_minutes_scheduled);
        formatter.field("total_scheduled_minutes", &self.total_scheduled_minutes);
        formatter.field("estimated_minutes_remaining", &self.estimated_minutes_remaining);
        formatter.finish()
    }
}
