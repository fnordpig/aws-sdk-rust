...
pub struct ParallelDataConfig  {
    ...
    #[doc(hidden)]pub format: std::option::Option<crate::model::ParallelDataFormat>,
}
...
pub struct TranslationSettings  {
    ...
    /// <p>For a list of target languages that support formality, see <a href="https://docs.aws.amazon.com/translate/latest/dg/customizing-translations-formality.html">Setting Formality</a> in the Amazon Translate Developer Guide.</p>
    #[doc(hidden)]pub formality: std::option::Option<crate::model::Formality>,
    ...
    /// <p>Amazon Translate doesn't detect profanity in all of its supported languages. For languages that support profanity detection, see <a href="https://docs.aws.amazon.com/translate/latest/dg/customizing-translations-profanity.html">Masking profanity</a> in the Amazon Translate Developer Guide.</p> 
    ...
    #[doc(hidden)]pub profanity: std::option::Option<crate::model::Profanity>,
}
...
pub struct AppliedTerminology  {
    ...
    #[doc(hidden)]pub terms: std::option::Option<std::vec::Vec<crate::model::Term>>,
}
...
pub struct Term  {
    ...
    #[doc(hidden)]pub source_text: std::option::Option<std::string::String>,
    /// <p>The target text of the term being translated by the custom terminology.</p>
    #[doc(hidden)]pub target_text: std::option::Option<std::string::String>,
}
impl Term {
    /// <p>The source text of the term being translated by the custom terminology.</p>
...
pub struct TextTranslationJobProperties  {
    ...
    #[doc(hidden)]pub submitted_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct JobDetails  {
    ...
    #[doc(hidden)]pub translated_documents_count: std::option::Option<i32>,
    /// <p>The number of documents that could not be processed during a translation job.</p>
    #[doc(hidden)]pub documents_with_errors_count: std::option::Option<i32>,
    /// <p>The number of documents used as input in a translation job.</p>
    #[doc(hidden)]pub input_documents_count: std::option::Option<i32>,
}
impl JobDetails {
    /// <p>The number of documents successfully processed during a translation job.</p>
...
impl  std::fmt::Debug for JobDetails  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("translated_documents_count", &self.translated_documents_count);
        formatter.field("documents_with_errors_count", &self.documents_with_errors_count);
...
pub struct TextTranslationJobFilter  {
    ...
    #[doc(hidden)]pub submitted_before_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub submitted_after_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct TerminologyProperties  {
    ...
    #[doc(hidden)]pub size_bytes: std::option::Option<i32>,
    /// <p>The number of terms included in the custom terminology.</p>
    #[doc(hidden)]pub term_count: std::option::Option<i32>,
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub directionality: std::option::Option<crate::model::Directionality>,
    ...
    #[doc(hidden)]pub skipped_term_count: std::option::Option<i32>,
    /// <p>The format of the custom terminology input file.</p>
    #[doc(hidden)]pub format: std::option::Option<crate::model::TerminologyDataFormat>,
}
...
pub struct ParallelDataProperties  {
    ...
    #[doc(hidden)]pub imported_data_size: std::option::Option<i64>,
    /// <p>The number of records successfully imported from the parallel data input file.</p>
    #[doc(hidden)]pub imported_record_count: std::option::Option<i64>,
    /// <p>The number of records unsuccessfully imported from the parallel data input file.</p>
    #[doc(hidden)]pub failed_record_count: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub skipped_record_count: std::option::Option<i64>,
    /// <p>The encryption key used to encrypt this object.</p>
    #[doc(hidden)]pub encryption_key: std::option::Option<crate::model::EncryptionKey>,
...
pub struct TerminologyDataLocation  {
    ...
    #[doc(hidden)]pub repository_type: std::option::Option<std::string::String>,
