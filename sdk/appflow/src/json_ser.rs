...
pub fn serialize_structure_crate_model_salesforce_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SalesforceDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_383) = &input.data_transfer_api {
        object.key("dataTransferApi").string(var_383.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_snowflake_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SnowflakeDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_384) = &input.object {
        object.key("object").string(var_384.as_str());
    }
    if let Some(var_385) = &input.intermediate_bucket_name {
        object.key("intermediateBucketName").string(var_385.as_str());
    }
    if let Some(var_386) = &input.bucket_prefix {
        object.key("bucketPrefix").string(var_386.as_str());
    }
    if let Some(var_387) = &input.error_handling_config {
        let mut object_388 = object.key("errorHandlingConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_388, var_387)?;
        object_388.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_event_bridge_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EventBridgeDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_389) = &input.object {
        object.key("object").string(var_389.as_str());
    }
    if let Some(var_390) = &input.error_handling_config {
        let mut object_391 = object.key("errorHandlingConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_391, var_390)?;
        object_391.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_upsolver_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpsolverDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_393) = &input.bucket_prefix {
        object.key("bucketPrefix").string(var_393.as_str());
    }
    if let Some(var_394) = &input.s3_output_format_config {
        let mut object_395 = object.key("s3OutputFormatConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_upsolver_s3_output_format_config(&mut object_395, var_394)?;
        object_395.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_honeycode_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HoneycodeDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_396) = &input.object {
        object.key("object").string(var_396.as_str());
    }
    if let Some(var_397) = &input.error_handling_config {
        let mut object_398 = object.key("errorHandlingConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_398, var_397)?;
        object_398.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_customer_profiles_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomerProfilesDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_399) = &input.domain_name {
        object.key("domainName").string(var_399.as_str());
    }
    if let Some(var_400) = &input.object_type_name {
        object.key("objectTypeName").string(var_400.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_zendesk_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ZendeskDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_401) = &input.object {
        object.key("object").string(var_401.as_str());
    }
    if let Some(var_402) = &input.id_field_names {
        let mut array_403 = object.key("idFieldNames").start_array();
    ...
    if let Some(var_405) = &input.error_handling_config {
        let mut object_406 = object.key("errorHandlingConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_406, var_405)?;
        object_406.finish();
    }
    if let Some(var_407) = &input.write_operation_type {
        object.key("writeOperationType").string(var_407.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_custom_connector_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomConnectorDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_411) = &input.entity_name {
        object.key("entityName").string(var_411.as_str());
    }
    if let Some(var_412) = &input.error_handling_config {
        let mut object_413 = object.key("errorHandlingConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_413, var_412)?;
        object_413.finish();
    }
    if let Some(var_414) = &input.write_operation_type {
        object.key("writeOperationType").string(var_414.as_str());
    }
    if let Some(var_415) = &input.id_field_names {
        let mut array_416 = object.key("idFieldNames").start_array();
    ...
    if let Some(var_418) = &input.custom_properties {
        let mut object_419 = object.key("customProperties").start_object();
        for (key_420, value_421) in var_418 {
             {
                object_419.key(key_420.as_str()).string(value_421.as_str());
            }
        }
        object_419.finish();
    }
...
pub fn serialize_structure_crate_model_sapo_data_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SapoDataDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_422) = &input.object_path {
        object.key("objectPath").string(var_422.as_str());
    }
    if let Some(var_423) = &input.success_response_handling_config {
        let mut object_424 = object.key("successResponseHandlingConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_success_response_handling_config(&mut object_424, var_423)?;
        object_424.finish();
    }
    if let Some(var_425) = &input.id_field_names {
        let mut array_426 = object.key("idFieldNames").start_array();
    ...
    if let Some(var_430) = &input.write_operation_type {
        object.key("writeOperationType").string(var_430.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_s3_source_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3SourceProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_437) = &input.bucket_name {
        object.key("bucketName").string(var_437.as_str());
    }
    if let Some(var_438) = &input.bucket_prefix {
        object.key("bucketPrefix").string(var_438.as_str());
    }
    if let Some(var_439) = &input.s3_input_format_config {
        let mut object_440 = object.key("s3InputFormatConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_s3_input_format_config(&mut object_440, var_439)?;
        object_440.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_salesforce_source_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SalesforceSourceProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_442) = &input.data_transfer_api {
        object.key("dataTransferApi").string(var_442.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_trendmicro_source_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TrendmicroSourceProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_446) = &input.object {
        object.key("object").string(var_446.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_veeva_source_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VeevaSourceProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_448) = &input.document_type {
        object.key("documentType").string(var_448.as_str());
    }
...
pub fn serialize_structure_crate_model_zendesk_source_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ZendeskSourceProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_449) = &input.object {
        object.key("object").string(var_449.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_sapo_data_source_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SapoDataSourceProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_450) = &input.object_path {
        object.key("objectPath").string(var_450.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_custom_connector_source_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomConnectorSourceProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_451) = &input.entity_name {
        object.key("entityName").string(var_451.as_str());
    }
    if let Some(var_452) = &input.custom_properties {
        let mut object_453 = object.key("customProperties").start_object();
        for (key_454, value_455) in var_452 {
             {
                object_453.key(key_454.as_str()).string(value_455.as_str());
            }
        }
        object_453.finish();
    }
...
pub fn serialize_structure_crate_model_scheduled_trigger_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScheduledTriggerProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_456) = &input.schedule_expression {
        object.key("scheduleExpression").string(var_456.as_str());
    }
    if let Some(var_457) = &input.data_pull_mode {
        object.key("dataPullMode").string(var_457.as_str());
    }
    if let Some(var_458) = &input.schedule_start_time {
        object.key("scheduleStartTime").date_time(var_458, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_459) = &input.schedule_end_time {
        object.key("scheduleEndTime").date_time(var_459, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_460) = &input.timezone {
        object.key("timezone").string(var_460.as_str());
    }
    if let Some(var_461) = &input.schedule_offset {
        object.key("scheduleOffset").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_461).into()));
    }
    if let Some(var_462) = &input.first_execution_from {
        object.key("firstExecutionFrom").date_time(var_462, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_463) = &input.flow_error_deactivation_threshold {
        object.key("flowErrorDeactivationThreshold").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_463).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_o_auth_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OAuthProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_464) = &input.token_url {
        object.key("tokenUrl").string(var_464.as_str());
    }
    if let Some(var_465) = &input.auth_code_url {
        object.key("authCodeUrl").string(var_465.as_str());
    }
    if let Some(var_466) = &input.o_auth_scopes {
        let mut array_467 = object.key("oAuthScopes").start_array();
...
pub fn serialize_structure_crate_model_o_auth2_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OAuth2Properties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_469) = &input.token_url {
        object.key("tokenUrl").string(var_469.as_str());
    }
    if let Some(var_470) = &input.o_auth2_grant_type {
        object.key("oAuth2GrantType").string(var_470.as_str());
    }
    if let Some(var_471) = &input.token_url_custom_properties {
        let mut object_472 = object.key("tokenUrlCustomProperties").start_object();
...
pub fn serialize_structure_crate_model_connector_o_auth_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConnectorOAuthRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_475) = &input.auth_code {
        object.key("authCode").string(var_475.as_str());
    }
    if let Some(var_476) = &input.redirect_uri {
        object.key("redirectUri").string(var_476.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_basic_auth_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BasicAuthCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_477) = &input.username {
        object.key("username").string(var_477.as_str());
    }
    if let Some(var_478) = &input.password {
        object.key("password").string(var_478.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_o_auth_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OAuthCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_479) = &input.client_id {
        object.key("clientId").string(var_479.as_str());
    }
    if let Some(var_480) = &input.client_secret {
        object.key("clientSecret").string(var_480.as_str());
    }
    if let Some(var_481) = &input.access_token {
        object.key("accessToken").string(var_481.as_str());
    }
    if let Some(var_482) = &input.refresh_token {
        object.key("refreshToken").string(var_482.as_str());
    }
    if let Some(var_483) = &input.o_auth_request {
        let mut object_484 = object.key("oAuthRequest").start_object();
        crate::json_ser::serialize_structure_crate_model_connector_o_auth_request(&mut object_484, var_483)?;
        object_484.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_o_auth2_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OAuth2Credentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_485) = &input.client_id {
        object.key("clientId").string(var_485.as_str());
    }
    if let Some(var_486) = &input.client_secret {
        object.key("clientSecret").string(var_486.as_str());
    }
    if let Some(var_487) = &input.access_token {
        object.key("accessToken").string(var_487.as_str());
    }
    if let Some(var_488) = &input.refresh_token {
        object.key("refreshToken").string(var_488.as_str());
    }
    if let Some(var_489) = &input.o_auth_request {
        let mut object_490 = object.key("oAuthRequest").start_object();
        crate::json_ser::serialize_structure_crate_model_connector_o_auth_request(&mut object_490, var_489)?;
        object_490.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_api_key_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ApiKeyCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_491) = &input.api_key {
        object.key("apiKey").string(var_491.as_str());
    }
    if let Some(var_492) = &input.api_secret_key {
        object.key("apiSecretKey").string(var_492.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_custom_auth_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomAuthCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_493) = &input.custom_authentication_type {
        object.key("customAuthenticationType").string(var_493.as_str());
    }
    if let Some(var_494) = &input.credentials_map {
        let mut object_495 = object.key("credentialsMap").start_object();
        for (key_496, value_497) in var_494 {
             {
                object_495.key(key_496.as_str()).string(value_497.as_str());
            }
        }
        object_495.finish();
    }
...
pub fn serialize_structure_crate_model_s3_output_format_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3OutputFormatConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_500) = &input.file_type {
        object.key("fileType").string(var_500.as_str());
    }
    if let Some(var_501) = &input.prefix_config {
        let mut object_502 = object.key("prefixConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_prefix_config(&mut object_502, var_501)?;
        object_502.finish();
    }
    if let Some(var_503) = &input.aggregation_config {
        let mut object_504 = object.key("aggregationConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_aggregation_config(&mut object_504, var_503)?;
        object_504.finish();
    }
    if let Some(var_505) = &input.preserve_source_data_typing {
        object.key("preserveSourceDataTyping").boolean(*var_505);
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_upsolver_s3_output_format_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpsolverS3OutputFormatConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_506) = &input.file_type {
        object.key("fileType").string(var_506.as_str());
    }
    if let Some(var_507) = &input.prefix_config {
        let mut object_508 = object.key("prefixConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_prefix_config(&mut object_508, var_507)?;
        object_508.finish();
    }
    if let Some(var_509) = &input.aggregation_config {
        let mut object_510 = object.key("aggregationConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_aggregation_config(&mut object_510, var_509)?;
        object_510.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_success_response_handling_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SuccessResponseHandlingConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_511) = &input.bucket_prefix {
        object.key("bucketPrefix").string(var_511.as_str());
    }
    if let Some(var_512) = &input.bucket_name {
        object.key("bucketName").string(var_512.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_s3_input_format_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3InputFormatConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_513) = &input.s3_input_file_type {
        object.key("s3InputFileType").string(var_513.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_prefix_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PrefixConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_514) = &input.prefix_type {
        object.key("prefixType").string(var_514.as_str());
    }
    if let Some(var_515) = &input.prefix_format {
        object.key("prefixFormat").string(var_515.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_aggregation_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AggregationConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_516) = &input.aggregation_type {
        object.key("aggregationType").string(var_516.as_str());
    }
    Ok(())
}
