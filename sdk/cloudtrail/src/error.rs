...
impl  std::fmt::Debug for NoManagementAccountSlrExistsException  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("NoManagementAccountSlrExistsException");
        formatter.field("message", &self.message);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for NotOrganizationManagementAccountException  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("NotOrganizationManagementAccountException");
        formatter.field("message", &self.message);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for DelegatedAdminAccountLimitExceededException  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DelegatedAdminAccountLimitExceededException");
        formatter.field("message", &self.message);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for CannotDelegateManagementAccountException  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CannotDelegateManagementAccountException");
        formatter.field("message", &self.message);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for AccountRegisteredException  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("AccountRegisteredException");
        formatter.field("message", &self.message);
        formatter.finish()
    }
}
