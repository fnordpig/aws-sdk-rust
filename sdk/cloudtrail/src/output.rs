...
impl  std::fmt::Debug for RegisterOrganizationDelegatedAdminOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("RegisterOrganizationDelegatedAdminOutput");
        formatter.finish()
    }
}
...
pub struct DescribeQueryOutput  {
    ...
    #[doc(hidden)]pub delivery_status: std::option::Option<crate::model::DeliveryStatus>,
}
...
impl  std::fmt::Debug for DeregisterOrganizationDelegatedAdminOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeregisterOrganizationDelegatedAdminOutput");
        formatter.finish()
    }
}
