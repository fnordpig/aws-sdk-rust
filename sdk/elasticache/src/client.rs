...
impl Client  {
    ...
    pub fn authorize_cache_security_group_ingress(&self) -> fluent_builders::AuthorizeCacheSecurityGroupIngress {
    ...
    ///   - [`transit_encryption_enabled(bool)`](crate::client::fluent_builders::CreateCacheCluster::transit_encryption_enabled) / [`set_transit_encryption_enabled(Option<bool>)`](crate::client::fluent_builders::CreateCacheCluster::set_transit_encryption_enabled): <p>A flag that enables in-transit encryption when set to true. You cannot modify the value of TransitEncryptionEnabled after the cluster is created. To enable in-transit encryption on a cluster you must set <code>TransitEncryptionEnabled</code> to true when you create a cluster.</p>  <p> Only available when creating a cache cluster in an Amazon VPC using Memcached version 1.6.12 or later.</p>
    ...
    pub fn decrease_node_groups_in_global_replication_group(&self) -> fluent_builders::DecreaseNodeGroupsInGlobalReplicationGroup {
    ...
    pub fn describe_global_replication_groups(&self) -> fluent_builders::DescribeGlobalReplicationGroups {
    ...
    pub fn describe_reserved_cache_nodes_offerings(&self) -> fluent_builders::DescribeReservedCacheNodesOfferings {
    ...
    pub fn disassociate_global_replication_group(&self) -> fluent_builders::DisassociateGlobalReplicationGroup {
    ...
    pub fn failover_global_replication_group(&self) -> fluent_builders::FailoverGlobalReplicationGroup {
    ...
    pub fn increase_node_groups_in_global_replication_group(&self) -> fluent_builders::IncreaseNodeGroupsInGlobalReplicationGroup {
    ...
    pub fn list_allowed_node_type_modifications(&self) -> fluent_builders::ListAllowedNodeTypeModifications {
    ...
    pub fn modify_replication_group_shard_configuration(&self) -> fluent_builders::ModifyReplicationGroupShardConfiguration {
    ...
    pub fn purchase_reserved_cache_nodes_offering(&self) -> fluent_builders::PurchaseReservedCacheNodesOffering {
    ...
    pub fn rebalance_slots_in_global_replication_group(&self) -> fluent_builders::RebalanceSlotsInGlobalReplicationGroup {
    ...
    pub fn revoke_cache_security_group_ingress(&self) -> fluent_builders::RevokeCacheSecurityGroupIngress {
...
pub mod fluent_builders {
    ...
    impl CreateCacheCluster  {
        ...
        /// <p>A flag that enables in-transit encryption when set to true. You cannot modify the value of TransitEncryptionEnabled after the cluster is created. To enable in-transit encryption on a cluster you must set <code>TransitEncryptionEnabled</code> to true when you create a cluster.</p> 
    ...
    impl ModifyReplicationGroup  {
        ...
        #[deprecated]pub fn node_group_id(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.node_group_id(input.into());
            self
        }
        /// <p>Deprecated. This parameter is not used.</p>
        #[deprecated]pub fn set_node_group_id(mut self, input: std::option::Option<std::string::String>) -> Self {
