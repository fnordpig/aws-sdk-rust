...
impl  std::fmt::Debug for UpdateSourceControlFromJobOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateSourceControlFromJobOutput");
...
impl  std::fmt::Debug for UpdateJobFromSourceControlOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateJobFromSourceControlOutput");
        formatter.field("job_name", &self.job_name);
        formatter.finish()
    }
}
