...
impl  std::fmt::Debug for PutResourceSetOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("PutResourceSetOutput");
...
pub struct PutProtocolsListOutput  {
    ...
    #[doc(hidden)]pub protocols_list_arn: std::option::Option<std::string::String>,
}
...
pub struct PutAppsListOutput  {
    ...
    #[doc(hidden)]pub apps_list_arn: std::option::Option<std::string::String>,
}
...
pub struct ListThirdPartyFirewallFirewallPoliciesOutput  {
    ...
    #[doc(hidden)]pub third_party_firewall_firewall_policies: std::option::Option<std::vec::Vec<crate::model::ThirdPartyFirewallFirewallPolicy>>,
...
impl  std::fmt::Debug for ListThirdPartyFirewallFirewallPoliciesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("third_party_firewall_firewall_policies", &self.third_party_firewall_firewall_policies);
...
pub struct ListResourceSetsOutput  {
    ...
    #[doc(hidden)]pub resource_sets: std::option::Option<std::vec::Vec<crate::model::ResourceSetSummary>>,
...
pub struct ListResourceSetResourcesOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::Resource>>,
    /// <p>When you request a list of objects with a <code>MaxResults</code> setting, if the number of objects that are still available for retrieval exceeds the maximum you requested, Firewall Manager returns a <code>NextToken</code> value in the response. To retrieve the next batch of objects, use the token returned from the prior request in your next request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListResourceSetResourcesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListResourceSetResourcesOutput");
...
pub struct ListProtocolsListsOutput  {
    ...
    #[doc(hidden)]pub protocols_lists: std::option::Option<std::vec::Vec<crate::model::ProtocolsListDataSummary>>,
...
pub struct ListPoliciesOutput  {
    ...
    #[doc(hidden)]pub policy_list: std::option::Option<std::vec::Vec<crate::model::PolicySummary>>,
...
pub struct ListMemberAccountsOutput  {
    ...
    #[doc(hidden)]pub member_accounts: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct ListDiscoveredResourcesOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::DiscoveredResource>>,
    /// <p>When you request a list of objects with a <code>MaxResults</code> setting, if the number of objects that are still available for retrieval exceeds the maximum you requested, Firewall Manager returns a <code>NextToken</code> value in the response. To retrieve the next batch of objects, use the token returned from the prior request in your next request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListComplianceStatusOutput  {
    ...
    #[doc(hidden)]pub policy_compliance_status_list: std::option::Option<std::vec::Vec<crate::model::PolicyComplianceStatus>>,
...
impl  std::fmt::Debug for ListComplianceStatusOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("policy_compliance_status_list", &self.policy_compliance_status_list);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct ListAppsListsOutput  {
    ...
    #[doc(hidden)]pub apps_lists: std::option::Option<std::vec::Vec<crate::model::AppsListDataSummary>>,
    /// <p>If you specify a value for <code>MaxResults</code> in your list request, and you have more objects than the maximum, Firewall Manager returns this token in the response. You can use this token in subsequent requests to retrieve the next batch of objects.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetViolationDetailsOutput  {
    ...
    #[doc(hidden)]pub violation_detail: std::option::Option<crate::model::ViolationDetail>,
}
...
pub struct GetThirdPartyFirewallAssociationStatusOutput  {
    ...
    /// </ul>
    #[doc(hidden)]pub third_party_firewall_status: std::option::Option<crate::model::ThirdPartyFirewallAssociationStatus>,
    ...
    /// </ul>
    #[doc(hidden)]pub marketplace_onboarding_status: std::option::Option<crate::model::MarketplaceSubscriptionOnboardingStatus>,
}
...
impl  std::fmt::Debug for GetThirdPartyFirewallAssociationStatusOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("third_party_firewall_status", &self.third_party_firewall_status);
        formatter.field("marketplace_onboarding_status", &self.marketplace_onboarding_status);
        formatter.finish()
    }
}
...
pub struct GetProtectionStatusOutput  {
    ...
    #[doc(hidden)]pub service_type: std::option::Option<crate::model::SecurityServiceType>,
...
pub struct GetComplianceDetailOutput  {
    ...
    #[doc(hidden)]pub policy_compliance_detail: std::option::Option<crate::model::PolicyComplianceDetail>,
}
...
pub struct GetAdminAccountOutput  {
    ...
    #[doc(hidden)]pub role_status: std::option::Option<crate::model::AccountRoleStatus>,
}
...
pub struct BatchDisassociateResourceOutput  {
    ...
    #[doc(hidden)]pub failed_items: std::option::Option<std::vec::Vec<crate::model::FailedItem>>,
}
...
impl  std::fmt::Debug for BatchDisassociateResourceOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchDisassociateResourceOutput");
...
impl  std::fmt::Debug for BatchAssociateResourceOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchAssociateResourceOutput");
        formatter.field("resource_set_identifier", &self.resource_set_identifier);
        formatter.field("failed_items", &self.failed_items);
        formatter.finish()
    }
