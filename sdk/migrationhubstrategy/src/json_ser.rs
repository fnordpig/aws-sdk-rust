...
pub fn serialize_union_crate_model_management_preference(object_57: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ManagementPreference) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub fn serialize_union_crate_model_database_migration_preference(object_60: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatabaseMigrationPreference) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
