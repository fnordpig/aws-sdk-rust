...
pub struct AccessorSummary  {
    ...
    /// </note>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::AccessorType>,
    /// <p>The current status of the accessor.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::AccessorStatus>,
...
impl  std::fmt::Debug for AccessorSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("AccessorSummary");
        formatter.field("id", &self.id);
...
impl std::convert::From<&str> for AccessorStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccessorStatus::Unknown(other.to_owned())
        }
    }
}
...
impl AccessorStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            AccessorStatus::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for AccessorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccessorType::Unknown(other.to_owned())
        }
    }
}
...
impl AccessorType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            AccessorType::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl  std::fmt::Debug for Accessor  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("Accessor");
        formatter.field("id", &self.id);
        formatter.field("r#type", &self.r#type);
