...
pub struct ListAccessorsOutput  {
    ...
    #[doc(hidden)]pub accessors: std::option::Option<std::vec::Vec<crate::model::AccessorSummary>>,
    /// <p> The pagination token that indicates the next set of results to retrieve. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListAccessorsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListAccessorsOutput");
        formatter.field("accessors", &self.accessors);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct GetAccessorOutput  {
    ...
    #[doc(hidden)]pub accessor: std::option::Option<crate::model::Accessor>,
}
...
impl  std::fmt::Debug for GetAccessorOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetAccessorOutput");
        formatter.field("accessor", &self.accessor);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for DeleteAccessorOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeleteAccessorOutput");
        formatter.finish()
    }
}
...
pub struct CreateAccessorOutput  {
    ...
    #[doc(hidden)]pub billing_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for CreateAccessorOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CreateAccessorOutput");
        formatter.field("accessor_id", &self.accessor_id);
        formatter.field("billing_token", &self.billing_token);
        formatter.finish()
    }
}
