...
pub fn serialize_structure_crate_input_get_auto_merging_preview_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAutoMergingPreviewInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_62) = &input.conflict_resolution {
        ...
        crate::json_ser::serialize_structure_crate_model_conflict_resolution(&mut object_63, var_62)?;
        object_63.finish();
    }
    ...
    if let Some(var_66) = &input.min_allowed_confidence_score_for_merging {
        object.key("MinAllowedConfidenceScoreForMerging").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_66).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_list_workflows_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListWorkflowsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_73) = &input.query_end_date {
        object.key("QueryEndDate").date_time(var_73, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_74) = &input.query_start_date {
        object.key("QueryStartDate").date_time(var_74, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub fn serialize_structure_crate_input_merge_profiles_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::MergeProfilesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_77) = &input.field_source_profile_ids {
        ...
        crate::json_ser::serialize_structure_crate_model_field_source_profile_ids(&mut object_78, var_77)?;
        object_78.finish();
    }
...
pub fn serialize_structure_crate_input_put_profile_object_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutProfileObjectTypeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_99) = &input.expiration_days {
        object.key("ExpirationDays").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_99).into()));
    }
    if let Some(var_100) = &input.fields {
        let mut object_101 = object.key("Fields").start_object();
        for (key_102, value_103) in var_100 {
             {
                let mut object_104 = object_101.key(key_102.as_str()).start_object();
                crate::json_ser::serialize_structure_crate_model_object_type_field(&mut object_104, value_103)?;
                object_104.finish();
            }
        }
        object_101.finish();
    ...
    if let Some(var_105) = &input.keys {
        ...
        for (key_107, value_108) in var_105 {
             {
                let mut array_109 = object_106.key(key_107.as_str()).start_array();
                for item_110 in value_108 {
                     {
                        let mut object_111 = array_109.value().start_object();
                        crate::json_ser::serialize_structure_crate_model_object_type_key(&mut object_111, item_110)?;
                        object_111.finish();
                    }
                }
                array_109.finish();
    ...
    if let Some(var_112) = &input.source_last_updated_timestamp_format {
        object.key("SourceLastUpdatedTimestampFormat").string(var_112.as_str());
    }
...
pub fn serialize_structure_crate_input_update_domain_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDomainInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_128) = &input.default_expiration_days {
        object.key("DefaultExpirationDays").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_128).into()));
    }
    if let Some(var_129) = &input.matching {
        let mut object_130 = object.key("Matching").start_object();
        crate::json_ser::serialize_structure_crate_model_matching_request(&mut object_130, var_129)?;
        object_130.finish();
    }
...
pub fn serialize_structure_crate_model_matching_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MatchingRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_169) = &input.exporting_config {
        ...
        crate::json_ser::serialize_structure_crate_model_exporting_config(&mut object_170, var_169)?;
        object_170.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_integration_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IntegrationConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_171) = &input.appflow_integration {
        ...
        crate::json_ser::serialize_structure_crate_model_appflow_integration(&mut object_172, var_171)?;
        object_172.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_conflict_resolution(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConflictResolution) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_183) = &input.conflict_resolving_model {
        object.key("ConflictResolvingModel").string(var_183.as_str());
    }
...
pub fn serialize_structure_crate_model_field_source_profile_ids(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FieldSourceProfileIds) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_214) = &input.attributes {
        ...
        for (key_216, value_217) in var_214 {
             {
                object_215.key(key_216.as_str()).string(value_217.as_str());
            }
        }
        object_215.finish();
    }
...
pub fn serialize_structure_crate_model_flow_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FlowDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_221) = &input.source_flow_config {
        ...
        crate::json_ser::serialize_structure_crate_model_source_flow_config(&mut object_222, var_221)?;
        object_222.finish();
    }
...
pub fn serialize_structure_crate_model_auto_merging(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AutoMerging) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_253) = &input.conflict_resolution {
        ...
        crate::json_ser::serialize_structure_crate_model_conflict_resolution(&mut object_254, var_253)?;
        object_254.finish();
    }
    if let Some(var_255) = &input.min_allowed_confidence_score_for_merging {
        object.key("MinAllowedConfidenceScoreForMerging").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_255).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_exporting_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ExportingConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_256) = &input.s3_exporting {
        ...
        crate::json_ser::serialize_structure_crate_model_s3_exporting_config(&mut object_257, var_256)?;
        object_257.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_source_flow_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SourceFlowConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_266) = &input.incremental_pull_config {
        ...
        crate::json_ser::serialize_structure_crate_model_incremental_pull_config(&mut object_267, var_266)?;
        object_267.finish();
    }
    if let Some(var_268) = &input.source_connector_properties {
        ...
        crate::json_ser::serialize_structure_crate_model_source_connector_properties(&mut object_269, var_268)?;
        object_269.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_task(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Task) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_270) = &input.connector_operator {
        ...
        crate::json_ser::serialize_structure_crate_model_connector_operator(&mut object_271, var_270)?;
        object_271.finish();
    }
...
pub fn serialize_structure_crate_model_trigger_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TriggerConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_282) = &input.trigger_properties {
        ...
        crate::json_ser::serialize_structure_crate_model_trigger_properties(&mut object_283, var_282)?;
        object_283.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_batch(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Batch) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_286) = &input.start_time {
        object.key("StartTime").date_time(var_286, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_287) = &input.end_time {
        object.key("EndTime").date_time(var_287, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_source_connector_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SourceConnectorProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_289) = &input.marketo {
        ...
        crate::json_ser::serialize_structure_crate_model_marketo_source_properties(&mut object_290, var_289)?;
        object_290.finish();
    }
    if let Some(var_291) = &input.s3 {
        let mut object_292 = object.key("S3").start_object();
        crate::json_ser::serialize_structure_crate_model_s3_source_properties(&mut object_292, var_291)?;
        object_292.finish();
    }
    if let Some(var_293) = &input.salesforce {
        let mut object_294 = object.key("Salesforce").start_object();
        crate::json_ser::serialize_structure_crate_model_salesforce_source_properties(&mut object_294, var_293)?;
        object_294.finish();
    }
    if let Some(var_295) = &input.service_now {
        let mut object_296 = object.key("ServiceNow").start_object();
        crate::json_ser::serialize_structure_crate_model_service_now_source_properties(&mut object_296, var_295)?;
        object_296.finish();
    }
    if let Some(var_297) = &input.zendesk {
        let mut object_298 = object.key("Zendesk").start_object();
        crate::json_ser::serialize_structure_crate_model_zendesk_source_properties(&mut object_298, var_297)?;
        object_298.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_trigger_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TriggerProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_304) = &input.scheduled {
        ...
        crate::json_ser::serialize_structure_crate_model_scheduled_trigger_properties(&mut object_305, var_304)?;
        object_305.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_scheduled_trigger_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScheduledTriggerProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_314) = &input.schedule_start_time {
        object.key("ScheduleStartTime").date_time(var_314, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_315) = &input.schedule_end_time {
        object.key("ScheduleEndTime").date_time(var_315, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_316) = &input.timezone {
        object.key("Timezone").string(var_316.as_str());
    }
    if let Some(var_317) = &input.schedule_offset {
        object.key("ScheduleOffset").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_317).into()));
    }
    if let Some(var_318) = &input.first_execution_from {
        object.key("FirstExecutionFrom").date_time(var_318, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}
