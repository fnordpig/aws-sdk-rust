...
pub mod batch_execute_statement_input {
    ...
    pub struct Builder {
        ...
        pub(crate) parameter_sets: std::option::Option<std::vec::Vec<std::vec::Vec<crate::model::SqlParameter>>>,
...
pub mod begin_transaction_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::BeginTransactionInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl BeginTransactionInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::BeginTransaction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::BeginTransactionInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::BeginTransaction::new())
...
pub mod execute_sql_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ExecuteSqlInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl ExecuteSqlInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ExecuteSql, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ExecuteSqlInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::ExecuteSql::new())
...
pub mod rollback_transaction_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::RollbackTransactionInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl RollbackTransactionInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::RollbackTransaction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::RollbackTransactionInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::RollbackTransaction::new())
...
pub struct ExecuteStatementInput  {
    ...
    #[doc(hidden)]pub transaction_id: std::option::Option<std::string::String>,
    /// <p>A value that indicates whether to include metadata in the results.</p>
    #[doc(hidden)]pub include_result_metadata: bool,
    /// <p>A value that indicates whether to continue running the statement after the call times out. By default, the statement stops running when the call times out.</p> <note> 
    /// <p>For DDL statements, we recommend continuing to run the statement after the call times out. When a DDL statement terminates before it is finished running, it can result in errors and possibly corrupted data structures.</p> 
    /// </note>
    #[doc(hidden)]pub continue_after_timeout: bool,
    /// <p>Options that control how the result set is returned.</p>
    #[doc(hidden)]pub result_set_options: std::option::Option<crate::model::ResultSetOptions>,
    /// <p>A value that indicates whether to format the result set as a single JSON string. This parameter only applies to <code>SELECT</code> statements and is ignored for other types of statements. Allowed values are <code>NONE</code> and <code>JSON</code>. The default value is <code>NONE</code>. The result is returned in the <code>formattedRecords</code> field.</p> 
    /// <p>For usage information about the JSON format for result sets, see <a href="https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/data-api.html">Using the Data API</a> in the <i>Amazon Aurora User Guide</i>.</p>
    #[doc(hidden)]pub format_records_as: std::option::Option<crate::model::RecordsFormatType>,
}
impl ExecuteStatementInput {
    /// <p>The Amazon Resource Name (ARN) of the Aurora Serverless DB cluster.</p>
    pub fn resource_arn(&self) -> std::option::Option<& str> {
...
pub struct ExecuteSqlInput  {
    /// <p>The ARN of the Aurora Serverless DB cluster.</p>
    #[doc(hidden)]pub db_cluster_or_instance_arn: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the secret that enables access to the DB cluster. Enter the database user name and password for the credentials in the secret.</p> 
    /// <p>For information about creating the secret, see <a href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/create_database_secret.html">Create a database secret</a>.</p>
    #[doc(hidden)]pub aws_secret_store_arn: std::option::Option<std::string::String>,
    /// <p>One or more SQL statements to run on the DB cluster.</p> 
    /// <p>You can separate SQL statements from each other with a semicolon (;). Any valid SQL statement is permitted, including data definition, data manipulation, and commit statements. </p>
    #[doc(hidden)]pub sql_statements: std::option::Option<std::string::String>,
    /// <p>The name of the database.</p>
    #[doc(hidden)]pub database: std::option::Option<std::string::String>,
    /// <p>The name of the database schema.</p>
    #[doc(hidden)]pub schema: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for ExecuteSqlInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("db_cluster_or_instance_arn", &self.db_cluster_or_instance_arn);
...
pub struct BatchExecuteStatementInput  {
    ...
    /// <p>Array parameters are not supported.</p> 
    /// </note>
    #[doc(hidden)]pub parameter_sets: std::option::Option<std::vec::Vec<std::vec::Vec<crate::model::SqlParameter>>>,
    /// <p>The identifier of a transaction that was started by using the <code>BeginTransaction</code> operation. Specify the transaction ID of the transaction that you want to include the SQL statement in.</p> 
    /// <p>If the SQL statement is not part of a transaction, don't set this parameter.</p>
    #[doc(hidden)]pub transaction_id: std::option::Option<std::string::String>,
}
impl BatchExecuteStatementInput {
    ...
    /// <p>Array parameters are not supported.</p> 
    /// </note>
    pub fn parameter_sets(&self) -> std::option::Option<& [std::vec::Vec<crate::model::SqlParameter>]> {
