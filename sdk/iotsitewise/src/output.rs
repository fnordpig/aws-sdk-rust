...
pub struct ListAssetPropertiesOutput  {
    ...
    #[doc(hidden)]pub asset_property_summaries: std::option::Option<std::vec::Vec<crate::model::AssetPropertySummary>>,
    /// <p>The token for the next set of results, or null if there are no additional results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListAssetPropertiesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListAssetPropertiesOutput");
        formatter.field("asset_property_summaries", &self.asset_property_summaries);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct ListAssetModelPropertiesOutput  {
    ...
    #[doc(hidden)]pub asset_model_property_summaries: std::option::Option<std::vec::Vec<crate::model::AssetModelPropertySummary>>,
    /// <p>The token for the next set of results, or null if there are no additional results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListAssetModelPropertiesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListAssetModelPropertiesOutput");
        formatter.field("asset_model_property_summaries", &self.asset_model_property_summaries);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
