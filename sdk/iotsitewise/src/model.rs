...
pub struct AssetPropertySummary  {
    ...
    #[doc(hidden)]pub asset_composite_model_id: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for AssetPropertySummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("AssetPropertySummary");
        formatter.field("id", &self.id);
        formatter.field("alias", &self.alias);
        formatter.field("unit", &self.unit);
        formatter.field("notification", &self.notification);
        formatter.field("asset_composite_model_id", &self.asset_composite_model_id);
        formatter.finish()
    }
}
...
impl std::convert::From<&str> for ListAssetPropertiesFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListAssetPropertiesFilter::Unknown(other.to_owned())
        }
    }
}
...
impl ListAssetPropertiesFilter {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ListAssetPropertiesFilter::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct AssetModelPropertySummary  {
    ...
    #[doc(hidden)]pub asset_model_composite_model_id: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for AssetModelPropertySummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("AssetModelPropertySummary");
        formatter.field("id", &self.id);
        formatter.field("name", &self.name);
        formatter.field("data_type", &self.data_type);
        formatter.field("data_type_spec", &self.data_type_spec);
        formatter.field("unit", &self.unit);
        formatter.field("r#type", &self.r#type);
        formatter.field("asset_model_composite_model_id", &self.asset_model_composite_model_id);
        formatter.finish()
    }
}
...
impl std::convert::From<&str> for ListAssetModelPropertiesFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListAssetModelPropertiesFilter::Unknown(other.to_owned())
        }
    }
}
...
impl ListAssetModelPropertiesFilter {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ListAssetModelPropertiesFilter::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
