...
pub struct ListCustomVocabularyItemsOutput  {
    ...
    #[doc(hidden)]pub custom_vocabulary_items: std::option::Option<std::vec::Vec<crate::model::CustomVocabularyItem>>,
...
impl  std::fmt::Debug for ListCustomVocabularyItemsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListCustomVocabularyItemsOutput");
        formatter.field("bot_id", &self.bot_id);
        formatter.field("bot_version", &self.bot_version);
        formatter.field("locale_id", &self.locale_id);
        formatter.field("custom_vocabulary_items", &self.custom_vocabulary_items);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct BatchUpdateCustomVocabularyItemOutput  {
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::FailedCustomVocabularyItem>>,
    /// <p>The resources of the action to batch update response for the custom vocabulary item.</p>
    #[doc(hidden)]pub resources: std::option::Option<std::vec::Vec<crate::model::CustomVocabularyItem>>,
}
...
impl  std::fmt::Debug for BatchUpdateCustomVocabularyItemOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchUpdateCustomVocabularyItemOutput");
        formatter.field("bot_id", &self.bot_id);
        formatter.field("bot_version", &self.bot_version);
        formatter.field("locale_id", &self.locale_id);
...
impl  std::fmt::Debug for BatchDeleteCustomVocabularyItemOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchDeleteCustomVocabularyItemOutput");
        formatter.field("bot_id", &self.bot_id);
        formatter.field("bot_version", &self.bot_version);
        formatter.field("locale_id", &self.locale_id);
        formatter.field("errors", &self.errors);
...
impl  std::fmt::Debug for BatchCreateCustomVocabularyItemOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("BatchCreateCustomVocabularyItemOutput");
        formatter.field("bot_id", &self.bot_id);
        formatter.field("bot_version", &self.bot_version);
        formatter.field("locale_id", &self.locale_id);
        formatter.field("errors", &self.errors);
