...
pub struct CustomVocabularyItem  {
    ...
    #[doc(hidden)]pub phrase: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub display_as: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for CustomVocabularyItem  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CustomVocabularyItem");
        formatter.field("item_id", &self.item_id);
        formatter.field("phrase", &self.phrase);
        formatter.field("weight", &self.weight);
        formatter.field("display_as", &self.display_as);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for FailedCustomVocabularyItem  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("FailedCustomVocabularyItem");
        formatter.field("item_id", &self.item_id);
...
impl  std::fmt::Debug for CustomVocabularyEntryId  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CustomVocabularyEntryId");
        formatter.field("item_id", &self.item_id);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for NewCustomVocabularyItem  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("NewCustomVocabularyItem");
        formatter.field("phrase", &self.phrase);
        formatter.field("weight", &self.weight);
        formatter.field("display_as", &self.display_as);
        formatter.finish()
