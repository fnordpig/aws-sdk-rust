...
pub struct ExpenseField  {
    ...
    #[doc(hidden)]pub currency: std::option::Option<crate::model::ExpenseCurrency>,
    ...
    #[doc(hidden)]pub group_properties: std::option::Option<std::vec::Vec<crate::model::ExpenseGroupProperty>>,
}
impl ExpenseField {
    /// <p>The implied label of a detected element. Present alongside LabelDetection for explicit elements.</p>
...
impl  std::fmt::Debug for ExpenseField  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("group_properties", &self.group_properties);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for ExpenseGroupProperty  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ExpenseGroupProperty");
...
impl  std::fmt::Debug for ExpenseCurrency  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ExpenseCurrency");
