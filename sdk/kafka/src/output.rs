...
impl  std::fmt::Debug for UpdateStorageOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateStorageOutput");
...
pub struct ListNodesOutput  {
    ...
    #[doc(hidden)]pub node_info_list: std::option::Option<std::vec::Vec<crate::model::NodeInfo>>,
}
...
pub struct ListKafkaVersionsOutput  {
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub kafka_versions: std::option::Option<std::vec::Vec<crate::model::KafkaVersion>>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListClustersV2Output  {
    ...
    #[doc(hidden)]pub cluster_info_list: std::option::Option<std::vec::Vec<crate::model::Cluster>>,
...
pub struct ListClustersOutput  {
    /// <p>Information on each of the MSK clusters in the response.</p>
    #[doc(hidden)]pub cluster_info_list: std::option::Option<std::vec::Vec<crate::model::ClusterInfo>>,
    /// <p>The paginated results marker. When the result of a ListClusters operation is truncated, the call returns NextToken in the response. To get another batch of clusters, provide this token in your next request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListClusterOperationsOutput  {
    ...
    #[doc(hidden)]pub cluster_operation_info_list: std::option::Option<std::vec::Vec<crate::model::ClusterOperationInfo>>,
...
impl  std::fmt::Debug for ListClusterOperationsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("cluster_operation_info_list", &self.cluster_operation_info_list);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct GetCompatibleKafkaVersionsOutput  {
    ...
    #[doc(hidden)]pub compatible_kafka_versions: std::option::Option<std::vec::Vec<crate::model::CompatibleKafkaVersion>>,
}
...
pub struct GetBootstrapBrokersOutput  {
    ...
    #[doc(hidden)]pub bootstrap_broker_string: std::option::Option<std::string::String>,
    /// <p>A string containing one or more DNS names (or IP) and TLS port pairs.</p>
    #[doc(hidden)]pub bootstrap_broker_string_tls: std::option::Option<std::string::String>,
    /// <p>A string containing one or more DNS names (or IP) and Sasl Scram port pairs.</p>
    #[doc(hidden)]pub bootstrap_broker_string_sasl_scram: std::option::Option<std::string::String>,
    /// <p>A string that contains one or more DNS names (or IP addresses) and SASL IAM port pairs.</p>
    #[doc(hidden)]pub bootstrap_broker_string_sasl_iam: std::option::Option<std::string::String>,
    /// <p>A string containing one or more DNS names (or IP) and TLS port pairs.</p>
    #[doc(hidden)]pub bootstrap_broker_string_public_tls: std::option::Option<std::string::String>,
    /// <p>A string containing one or more DNS names (or IP) and Sasl Scram port pairs.</p>
    #[doc(hidden)]pub bootstrap_broker_string_public_sasl_scram: std::option::Option<std::string::String>,
    /// <p>A string that contains one or more DNS names (or IP addresses) and SASL IAM port pairs.</p>
    #[doc(hidden)]pub bootstrap_broker_string_public_sasl_iam: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for GetBootstrapBrokersOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("bootstrap_broker_string_tls", &self.bootstrap_broker_string_tls);
        formatter.field("bootstrap_broker_string_sasl_scram", &self.bootstrap_broker_string_sasl_scram);
        formatter.field("bootstrap_broker_string_sasl_iam", &self.bootstrap_broker_string_sasl_iam);
        formatter.field("bootstrap_broker_string_public_tls", &self.bootstrap_broker_string_public_tls);
        formatter.field("bootstrap_broker_string_public_sasl_scram", &self.bootstrap_broker_string_public_sasl_scram);
        formatter.field("bootstrap_broker_string_public_sasl_iam", &self.bootstrap_broker_string_public_sasl_iam);
        formatter.finish()
    }
}
...
pub struct DescribeClusterV2Output  {
    ...
    #[doc(hidden)]pub cluster_info: std::option::Option<crate::model::Cluster>,
}
...
pub struct DescribeClusterOperationOutput  {
    ...
    #[doc(hidden)]pub cluster_operation_info: std::option::Option<crate::model::ClusterOperationInfo>,
}
...
pub struct DescribeClusterOutput  {
    /// <p>The cluster information.</p>
    #[doc(hidden)]pub cluster_info: std::option::Option<crate::model::ClusterInfo>,
}
...
pub struct BatchDisassociateScramSecretOutput  {
    ...
    #[doc(hidden)]pub unprocessed_scram_secrets: std::option::Option<std::vec::Vec<crate::model::UnprocessedScramSecret>>,
}
