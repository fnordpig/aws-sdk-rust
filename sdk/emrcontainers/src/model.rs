...
pub struct JobTemplate  {
    ...
    #[doc(hidden)]pub job_template_data: std::option::Option<crate::model::JobTemplateData>,
    ...
    #[doc(hidden)]pub decryption_error: std::option::Option<std::string::String>,
}
impl JobTemplate {
    /// <p>The name of the job template.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
impl  std::fmt::Debug for JobTemplate  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("tags", &self.tags);
        formatter.field("job_template_data", &self.job_template_data);
        formatter.field("kms_key_arn", &self.kms_key_arn);
        formatter.field("decryption_error", &self.decryption_error);
        formatter.finish()
    }
}
...
pub struct JobTemplateData  {
    ...
    #[doc(hidden)]pub configuration_overrides: std::option::Option<crate::model::ParametricConfigurationOverrides>,
    /// <p>Specify the driver that the job runs on. Exactly one of the two available job drivers is required, either sparkSqlJobDriver or sparkSubmitJobDriver.</p>
    ...
    #[doc(hidden)]pub parameter_configuration: std::option::Option<std::collections::HashMap<std::string::String, crate::model::TemplateParameterConfiguration>>,
    /// <p>The tags assigned to jobs started using the job template.</p>
    #[doc(hidden)]pub job_tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
impl  std::fmt::Debug for JobTemplateData  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("JobTemplateData");
        formatter.field("execution_role_arn", &self.execution_role_arn);
        formatter.field("release_label", &self.release_label);
        formatter.field("configuration_overrides", &self.configuration_overrides);
        formatter.field("job_driver", &self.job_driver);
        formatter.field("parameter_configuration", &self.parameter_configuration);
...
pub struct TemplateParameterConfiguration  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::TemplateParameterDataType>,
...
impl  std::fmt::Debug for TemplateParameterConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("TemplateParameterConfiguration");
        formatter.field("r#type", &self.r#type);
...
impl std::convert::From<&str> for TemplateParameterDataType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TemplateParameterDataType::Unknown(other.to_owned())
        }
    }
}
...
impl TemplateParameterDataType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            TemplateParameterDataType::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct ParametricConfigurationOverrides  {
    ...
    #[doc(hidden)]pub application_configuration: std::option::Option<std::vec::Vec<crate::model::Configuration>>,
    /// <p> The configurations for monitoring. </p>
    #[doc(hidden)]pub monitoring_configuration: std::option::Option<crate::model::ParametricMonitoringConfiguration>,
}
...
impl  std::fmt::Debug for ParametricConfigurationOverrides  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ParametricConfigurationOverrides");
        formatter.field("application_configuration", &self.application_configuration);
        formatter.field("monitoring_configuration", &self.monitoring_configuration);
        formatter.finish()
    }
...
pub struct ParametricMonitoringConfiguration  {
    /// <p> Monitoring configurations for the persistent application UI.</p>
    #[doc(hidden)]pub persistent_app_ui: std::option::Option<std::string::String>,
    /// <p> Monitoring configurations for CloudWatch.</p>
    #[doc(hidden)]pub cloud_watch_monitoring_configuration: std::option::Option<crate::model::ParametricCloudWatchMonitoringConfiguration>,
    /// <p> Amazon S3 configuration for monitoring log publishing.</p>
    #[doc(hidden)]pub s3_monitoring_configuration: std::option::Option<crate::model::ParametricS3MonitoringConfiguration>,
}
...
impl  std::fmt::Debug for ParametricMonitoringConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ParametricMonitoringConfiguration");
        formatter.field("persistent_app_ui", &self.persistent_app_ui);
        formatter.field("cloud_watch_monitoring_configuration", &self.cloud_watch_monitoring_configuration);
        formatter.field("s3_monitoring_configuration", &self.s3_monitoring_configuration);
        formatter.finish()
...
impl  std::fmt::Debug for ParametricS3MonitoringConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ParametricS3MonitoringConfiguration");
        formatter.field("log_uri", &self.log_uri);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for ParametricCloudWatchMonitoringConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ParametricCloudWatchMonitoringConfiguration");
        formatter.field("log_group_name", &self.log_group_name);
        formatter.field("log_stream_name_prefix", &self.log_stream_name_prefix);
        formatter.finish()
    }
