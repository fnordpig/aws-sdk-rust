...
impl std::convert::From<&str> for DeletionProtectionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeletionProtectionType::Unknown(other.to_owned())
        }
    }
}
...
impl DeletionProtectionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            DeletionProtectionType::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct UserPoolType  {
    ...
    #[doc(hidden)]pub deletion_protection: std::option::Option<crate::model::DeletionProtectionType>,
