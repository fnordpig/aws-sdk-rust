...
pub struct OsUpdateSettings  {
    /// <p> OS version that the directory needs to be updated to. </p>
    #[doc(hidden)]pub os_version: std::option::Option<crate::model::OsVersion>,
}
...
impl  std::fmt::Debug for OsUpdateSettings  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("OsUpdateSettings");
...
impl std::convert::From<&str> for OsVersion {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OsVersion::Unknown(other.to_owned())
        }
    }
}
...
pub struct UpdateInfoEntry  {
    ...
    #[doc(hidden)]pub initiated_by: std::option::Option<std::string::String>,
    /// <p> The new value of the target setting. </p>
    #[doc(hidden)]pub new_value: std::option::Option<crate::model::UpdateValue>,
    /// <p> The old value of the target setting. </p>
    #[doc(hidden)]pub previous_value: std::option::Option<crate::model::UpdateValue>,
...
impl  std::fmt::Debug for UpdateInfoEntry  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateInfoEntry");
        formatter.field("region", &self.region);
        formatter.field("status", &self.status);
        formatter.field("status_reason", &self.status_reason);
        formatter.field("initiated_by", &self.initiated_by);
        formatter.field("new_value", &self.new_value);
        formatter.field("previous_value", &self.previous_value);
...
impl  std::fmt::Debug for UpdateValue  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateValue");
