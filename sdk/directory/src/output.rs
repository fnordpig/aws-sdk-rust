...
impl  std::fmt::Debug for UpdateDirectorySetupOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateDirectorySetupOutput");
        formatter.finish()
    }
}
...
pub struct DescribeUpdateDirectoryOutput  {
    ...
    #[doc(hidden)]pub update_activities: std::option::Option<std::vec::Vec<crate::model::UpdateInfoEntry>>,
...
impl  std::fmt::Debug for DescribeUpdateDirectoryOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DescribeUpdateDirectoryOutput");
        formatter.field("update_activities", &self.update_activities);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
