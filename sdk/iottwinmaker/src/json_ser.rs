...
pub fn serialize_union_crate_model_list_component_types_filter(object_82: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ListComponentTypesFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub fn serialize_union_crate_model_list_entities_filter(object_88: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ListEntitiesFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
