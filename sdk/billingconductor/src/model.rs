...
pub struct ListResourcesAssociatedToCustomLineItemResponseElement  {
    ...
    #[doc(hidden)]pub end_billing_period: std::option::Option<std::string::String>,
}
...
pub struct CustomLineItemVersionListElement  {
    ...
    #[doc(hidden)]pub start_billing_period: std::option::Option<std::string::String>,
...
pub struct ListCustomLineItemVersionsFilter  {
    ...
    #[doc(hidden)]pub billing_period_range: std::option::Option<crate::model::ListCustomLineItemVersionsBillingPeriodRangeFilter>,
}
...
impl  std::fmt::Debug for ListCustomLineItemVersionsFilter  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListCustomLineItemVersionsFilter");
...
impl  std::fmt::Debug for ListCustomLineItemVersionsBillingPeriodRangeFilter  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListCustomLineItemVersionsBillingPeriodRangeFilter");
        formatter.field("start_billing_period", &self.start_billing_period);
        formatter.field("end_billing_period", &self.end_billing_period);
        formatter.finish()
    }
