...
#[allow(clippy::unnecessary_wraps)]pub fn parse_list_custom_line_item_versions_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListCustomLineItemVersionsOutput, crate::error::ListCustomLineItemVersionsError> {
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_list_custom_line_item_versions_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListCustomLineItemVersionsOutput, crate::error::ListCustomLineItemVersionsError> {
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::list_custom_line_item_versions_output::Builder::default();
        let _ = response;
