...
pub struct ListCustomLineItemVersionsOutput  {
    ...
    #[doc(hidden)]pub custom_line_item_versions: std::option::Option<std::vec::Vec<crate::model::CustomLineItemVersionListElement>>,
...
impl  std::fmt::Debug for ListCustomLineItemVersionsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListCustomLineItemVersionsOutput");
        formatter.field("custom_line_item_versions", &self.custom_line_item_versions);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
