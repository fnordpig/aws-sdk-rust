...
pub fn serialize_union_crate_model_template_version_source_input(object_57: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TemplateVersionSourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
