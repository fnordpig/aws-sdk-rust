...
pub fn serialize_structure_crate_model_player(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Player) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_549) = &input.latency_in_ms {
        ...
        for (key_551, value_552) in var_549 {
             {
                object_550.key(key_551.as_str()).number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*value_552).into()));
            }
        }
        object_550.finish();
    }
...
pub fn serialize_structure_crate_model_attribute_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AttributeValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_562) = &input.sdm {
        ...
        for (key_564, value_565) in var_562 {
             {
                object_563.key(key_564.as_str()).number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*value_565).into()));
            }
        }
        object_563.finish();
    }
