...
impl TranscriptResultStream {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`TranscriptEvent`](crate::model::TranscriptResultStream::TranscriptEvent), extracting the inner [`TranscriptEvent`](crate::model::TranscriptEvent).
...
pub struct Transcript  {
    ...
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::Result>>,
}
impl Transcript {
    /// <p>Contains a set of transcription results from one or more audio segments, along with additional information per your request parameters. This can include information relating to alternative transcriptions, channel identification, partial result stabilization, language identification, and other transcription-related data.</p>
...
pub struct Result  {
    ...
    #[doc(hidden)]pub start_time: f64,
    /// <p>The end time, in milliseconds, of the <code>Result</code>.</p>
    #[doc(hidden)]pub end_time: f64,
    ...
    #[doc(hidden)]pub is_partial: bool,
    ...
    #[doc(hidden)]pub alternatives: std::option::Option<std::vec::Vec<crate::model::Alternative>>,
    ...
    #[doc(hidden)]pub language_identification: std::option::Option<std::vec::Vec<crate::model::LanguageWithScore>>,
}
impl Result {
    /// <p>Provides a unique identifier for the <code>Result</code>.</p>
...
pub struct Entity  {
    ...
    #[doc(hidden)]pub confidence: std::option::Option<f64>,
}
impl Entity {
    /// <p>The start time, in milliseconds, of the utterance that was identified as PII.</p>
    pub fn start_time(&self) -> f64 {
...
pub struct Item  {
    ...
    #[doc(hidden)]pub vocabulary_filter_match: bool,
    /// <p>If speaker partitioning is enabled, <code>Speaker</code> labels the speaker of the specified item.</p>
    #[doc(hidden)]pub speaker: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub stable: std::option::Option<bool>,
}
impl Item {
    /// <p>The start time, in milliseconds, of the transcribed item.</p>
    pub fn start_time(&self) -> f64 {
...
impl AudioStream {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`AudioEvent`](crate::model::AudioStream::AudioEvent), extracting the inner [`AudioEvent`](crate::model::AudioEvent).
    /// Returns `Err(&Self)` if it can't be converted.
...
pub struct AudioEvent  {
    ...
    #[doc(hidden)]pub audio_chunk: std::option::Option<aws_smithy_types::Blob>,
}
impl AudioEvent {
    /// <p>An audio blob that contains the next part of the audio that you want to transcribe. The maximum audio chunk size is 32 KB.</p>
...
impl MedicalTranscriptResultStream {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`TranscriptEvent`](crate::model::MedicalTranscriptResultStream::TranscriptEvent), extracting the inner [`MedicalTranscriptEvent`](crate::model::MedicalTranscriptEvent).
    /// Returns `Err(&Self)` if it can't be converted.
...
pub struct MedicalTranscript  {
    /// <p>Contains a set of transcription results from one or more audio segments, along with additional information per your request parameters. This can include information relating to alternative transcriptions, channel identification, partial result stabilization, language identification, and other transcription-related data.</p>
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::MedicalResult>>,
}
...
pub struct MedicalResult  {
    ...
    #[doc(hidden)]pub is_partial: bool,
    /// <p>A list of possible alternative transcriptions for the input audio. Each alternative may contain one or more of <code>Items</code>, <code>Entities</code>, or <code>Transcript</code>.</p>
    #[doc(hidden)]pub alternatives: std::option::Option<std::vec::Vec<crate::model::MedicalAlternative>>,
    /// <p>Indicates the channel identified for the <code>Result</code>.</p>
    #[doc(hidden)]pub channel_id: std::option::Option<std::string::String>,
}
impl MedicalResult {
...
pub struct MedicalAlternative  {
    ...
    #[doc(hidden)]pub transcript: std::option::Option<std::string::String>,
    /// <p>Contains words, phrases, or punctuation marks in your transcription output.</p>
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::MedicalItem>>,
    /// <p>Contains entities identified as personal health information (PHI) in your transcription output.</p>
    #[doc(hidden)]pub entities: std::option::Option<std::vec::Vec<crate::model::MedicalEntity>>,
}
