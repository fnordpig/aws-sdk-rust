...
pub struct UpdateUserAccessLoggingSettingsOutput  {
    ...
    #[doc(hidden)]pub user_access_logging_settings: std::option::Option<crate::model::UserAccessLoggingSettings>,
}
...
impl  std::fmt::Debug for UpdateUserAccessLoggingSettingsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateUserAccessLoggingSettingsOutput");
        formatter.field("user_access_logging_settings", &self.user_access_logging_settings);
        formatter.finish()
    }
}
...
pub struct ListUserAccessLoggingSettingsOutput  {
    /// <p>The user access logging settings.</p>
    #[doc(hidden)]pub user_access_logging_settings: std::option::Option<std::vec::Vec<crate::model::UserAccessLoggingSettingsSummary>>,
    /// <p>The pagination token used to retrieve the next page of results for this operation.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListUserAccessLoggingSettingsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListUserAccessLoggingSettingsOutput");
        formatter.field("user_access_logging_settings", &self.user_access_logging_settings);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
...
impl  std::fmt::Debug for GetUserAccessLoggingSettingsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetUserAccessLoggingSettingsOutput");
        formatter.field("user_access_logging_settings", &self.user_access_logging_settings);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for DisassociateUserAccessLoggingSettingsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DisassociateUserAccessLoggingSettingsOutput");
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for DeleteUserAccessLoggingSettingsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeleteUserAccessLoggingSettingsOutput");
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for CreateUserAccessLoggingSettingsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CreateUserAccessLoggingSettingsOutput");
...
impl  std::fmt::Debug for AssociateUserAccessLoggingSettingsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("AssociateUserAccessLoggingSettingsOutput");
        formatter.field("portal_arn", &self.portal_arn);
        formatter.field("user_access_logging_settings_arn", &self.user_access_logging_settings_arn);
        formatter.finish()
    }
