...
impl  std::fmt::Debug for UserAccessLoggingSettings  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UserAccessLoggingSettings");
...
impl  std::fmt::Debug for UserAccessLoggingSettingsSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UserAccessLoggingSettingsSummary");
        formatter.field("user_access_logging_settings_arn", &self.user_access_logging_settings_arn);
        formatter.field("kinesis_stream_arn", &self.kinesis_stream_arn);
        formatter.finish()
    }
