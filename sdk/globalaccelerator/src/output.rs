...
impl  std::fmt::Debug for RemoveEndpointsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("RemoveEndpointsOutput");
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for AddEndpointsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("AddEndpointsOutput");
