...
impl std::fmt::Display for DeleteConnectionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteConnectionErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteConnectionErrorKind::GoneException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteConnectionErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DeleteConnectionError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteConnectionErrorKind::LimitExceededException(_))
    }
}
...
impl std::fmt::Display for GetConnectionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetConnectionErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetConnectionErrorKind::GoneException(_inner) =>
            _inner.fmt(f)
            ,
            GetConnectionErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
...
impl GetConnectionError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, GetConnectionErrorKind::LimitExceededException(_))
    }
}
...
impl std::fmt::Display for PostToConnectionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            PostToConnectionErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            PostToConnectionErrorKind::GoneException(_inner) =>
            _inner.fmt(f)
            ,
            PostToConnectionErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            PostToConnectionErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            PostToConnectionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl PostToConnectionError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, PostToConnectionErrorKind::LimitExceededException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, PostToConnectionErrorKind::PayloadTooLargeException(_))
    }
}
