...
pub struct UserIdentityInfo  {
    ...
    #[doc(hidden)]pub secondary_email: std::option::Option<std::string::String>,
    /// <p>The user's mobile number.</p>
    #[doc(hidden)]pub mobile: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for UserIdentityInfo  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("secondary_email", &self.secondary_email);
...
impl  std::fmt::Debug for TelephonyConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("TelephonyConfig");
...
pub struct TrafficDistributionGroupSummary  {
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::TrafficDistributionGroupStatus>,
}
...
impl  std::fmt::Debug for TrafficDistributionGroupSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("TrafficDistributionGroupSummary");
        formatter.field("id", &self.id);
        formatter.field("arn", &self.arn);
        formatter.field("name", &self.name);
...
pub mod traffic_distribution_group_summary {
    ...
    impl Builder {
        ...
        /// <li> <p> <code>UPDATE_IN_PROGRESS</code> means the previous <a href="https://docs.aws.amazon.com/connect/latest/APIReference/API_UpdateTrafficDistributionGroup.html">UpdateTrafficDistributionGroup</a> operation is still in progress and has not yet completed.</p> </li> 
        /// </ul>
        pub fn set_status(mut self, input: std::option::Option<crate::model::TrafficDistributionGroupStatus>) -> Self {
            self.status = input; self
        }
...
impl std::convert::From<&str> for TrafficDistributionGroupStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrafficDistributionGroupStatus::Unknown(other.to_owned())
        }
    }
}
...
impl TrafficDistributionGroupStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            TrafficDistributionGroupStatus::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl  std::fmt::Debug for TrafficDistributionGroup  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("TrafficDistributionGroup");
        formatter.field("id", &self.id);
        formatter.field("arn", &self.arn);
        formatter.field("name", &self.name);
        formatter.field("description", &self.description);
