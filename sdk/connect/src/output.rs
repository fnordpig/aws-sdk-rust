...
impl  std::fmt::Debug for UpdateTrafficDistributionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateTrafficDistributionOutput");
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for ReplicateInstanceOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ReplicateInstanceOutput");
        formatter.field("id", &self.id);
        formatter.field("arn", &self.arn);
        formatter.finish()
    }
...
pub struct ListTrafficDistributionGroupsOutput  {
    ...
    #[doc(hidden)]pub traffic_distribution_group_summary_list: std::option::Option<std::vec::Vec<crate::model::TrafficDistributionGroupSummary>>,
}
...
impl  std::fmt::Debug for ListTrafficDistributionGroupsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListTrafficDistributionGroupsOutput");
        formatter.field("next_token", &self.next_token);
        formatter.field("traffic_distribution_group_summary_list", &self.traffic_distribution_group_summary_list);
        formatter.finish()
    }
}
...
pub struct GetTrafficDistributionOutput  {
    ...
    #[doc(hidden)]pub telephony_config: std::option::Option<crate::model::TelephonyConfig>,
...
impl  std::fmt::Debug for GetTrafficDistributionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetTrafficDistributionOutput");
        formatter.field("telephony_config", &self.telephony_config);
        formatter.field("id", &self.id);
        formatter.field("arn", &self.arn);
        formatter.finish()
    }
...
pub struct GetFederationTokenOutput  {
    ...
    #[doc(hidden)]pub sign_in_url: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for DismissUserContactOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DismissUserContactOutput");
        formatter.finish()
    }
}
...
pub struct DescribeTrafficDistributionGroupOutput  {
    ...
    #[doc(hidden)]pub traffic_distribution_group: std::option::Option<crate::model::TrafficDistributionGroup>,
}
...
impl  std::fmt::Debug for DescribeTrafficDistributionGroupOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DescribeTrafficDistributionGroupOutput");
        formatter.field("traffic_distribution_group", &self.traffic_distribution_group);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for DeleteTrafficDistributionGroupOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeleteTrafficDistributionGroupOutput");
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for CreateTrafficDistributionGroupOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CreateTrafficDistributionGroupOutput");
        formatter.field("id", &self.id);
        formatter.field("arn", &self.arn);
        formatter.finish()
    }
