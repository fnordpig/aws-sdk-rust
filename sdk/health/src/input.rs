...
pub mod describe_affected_accounts_for_organization_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeAffectedAccountsForOrganizationInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl DescribeAffectedAccountsForOrganizationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeAffectedAccountsForOrganization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeAffectedAccountsForOrganizationInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
...
pub mod describe_affected_entities_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeAffectedEntitiesInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl DescribeAffectedEntitiesInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeAffectedEntities, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeAffectedEntitiesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod describe_affected_entities_for_organization_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeAffectedEntitiesForOrganizationInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl DescribeAffectedEntitiesForOrganizationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeAffectedEntitiesForOrganization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeAffectedEntitiesForOrganizationInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod describe_entity_aggregates_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeEntityAggregatesInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl DescribeEntityAggregatesInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeEntityAggregates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeEntityAggregatesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod describe_event_aggregates_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeEventAggregatesInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl DescribeEventAggregatesInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeEventAggregates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeEventAggregatesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod describe_event_details_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeEventDetailsInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl DescribeEventDetailsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeEventDetails, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeEventDetailsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod describe_event_details_for_organization_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeEventDetailsForOrganizationInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl DescribeEventDetailsForOrganizationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeEventDetailsForOrganization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeEventDetailsForOrganizationInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod describe_events_for_organization_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeEventsForOrganizationInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl DescribeEventsForOrganizationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeEventsForOrganization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeEventsForOrganizationInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod describe_event_types_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeEventTypesInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl DescribeEventTypesInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeEventTypes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeEventTypesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod describe_health_service_status_for_organization_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeHealthServiceStatusForOrganizationInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl DescribeHealthServiceStatusForOrganizationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeHealthServiceStatusForOrganization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeHealthServiceStatusForOrganizationInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod disable_health_service_access_for_organization_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DisableHealthServiceAccessForOrganizationInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl DisableHealthServiceAccessForOrganizationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DisableHealthServiceAccessForOrganization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DisableHealthServiceAccessForOrganizationInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod enable_health_service_access_for_organization_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::EnableHealthServiceAccessForOrganizationInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl EnableHealthServiceAccessForOrganizationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::EnableHealthServiceAccessForOrganization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::EnableHealthServiceAccessForOrganizationInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
